...
import { t as faqs } from "./roi-calculator-DIoMuPOX.js";
...
//#region src/routes/roi-calculator.tsx?tsr-split=component
var fmtUSD = (n) => new Intl.NumberFormat("en-US", {
	style: "currency",
	currency: "USD",
...
function Page() {
	...
	const { hoursSavedYr, laborSavingsYr, revenueRecoveredYr, totalYr, innrlyCostYr } = useMemo(() => {
		const HOURS_PER_WEEK = 10;
		const REVENUE_RECOVERY_PCT = .0025;
		...
		return {
			...
			laborSavingsYr,
			revenueRecoveredYr,
			totalYr: laborSavingsYr + revenueRecoveredYr,
			innrlyCostYr: properties * 199 * 12
		};
	}, [
		properties,
		hourlyCost,
		...
		children: [
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("p", {
							...
							children: "Built from real multi-property operator data — hours saved, revenue recovered, and total annual return on the Innrly subscription."
						})
					]
				})]
			}),
			/* @__PURE__ */ jsx(Section, {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						className: "aurora-card rounded-2xl p-6 sm:p-8",
						children: [
							/* @__PURE__ */ jsx("div", {
							...
							/* @__PURE__ */ jsx("p", {
								...
								children: "Calculator assumes 10 hours/week saved per property (operator midpoint) and 25 bps revenue recovery from OTA commission clawback + card chargeback auditing."
							})
						]
					}), /* @__PURE__ */ jsxs("div", {
						className: "space-y-4",
						children: [
							...
							/* @__PURE__ */ jsx(Stat, {
								icon: DollarSign,
								label: "Labor savings / year",
								value: fmtUSD(laborSavingsYr)
							}),
							/* @__PURE__ */ jsx(Stat, {
								icon: TrendingUp,
							...
							/* @__PURE__ */ jsxs("div", {
								className: "aurora-card rounded-2xl border-2 border-accent/40 p-6",
								children: [
									/* @__PURE__ */ jsx("p", {
										className: "text-xs font-semibold uppercase tracking-widest text-accent",
										children: "Total annual return"
									}),
									/* @__PURE__ */ jsx("p", {
										className: "mt-2 text-4xl font-bold text-gradient sm:text-5xl",
										children: fmtUSD(totalYr)
									}),
									/* @__PURE__ */ jsxs("p", {
										...
										children: [
											...
											/* @__PURE__ */ jsxs("span", {
												...
												children: [fmtUSD(innrlyCostYr), "/yr"]
											}),
											" ·",
											" ",
											/* @__PURE__ */ jsxs("span", {
												className: "font-semibold text-foreground",
												children: [roiX.toFixed(1), "× ROI"]
											})
										]
									})
								]
...
function Stat({ icon: Icon, label, value, accent = false }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			className: "inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-cta",
