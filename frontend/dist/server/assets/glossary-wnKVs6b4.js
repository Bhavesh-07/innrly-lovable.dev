		...
		children: [/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsx("div", {
				...
				children: [/* @__PURE__ */ jsxs("h1", {
					...
					children: ["Hotel operations ", /* @__PURE__ */ jsx("span", {
						className: "text-gradient",
						children: "glossary."
					})]
				}), /* @__PURE__ */ jsx("p", {
					className: "mt-4 text-lg text-muted-foreground",
					children: "Plain-English definitions for the finance, labor, and operations terms multi-property operators use every day."
				})]
			})]
		}), /* @__PURE__ */ jsxs(Section, { children: [
			/* @__PURE__ */ jsx("div", {
				className: "sticky top-16 z-10 -mx-4 mb-8 flex flex-wrap justify-center gap-1 border-y border-border/60 bg-background/85 px-4 py-3 backdrop-blur-xl sm:-mx-6 lg:-mx-8",
				children: alphabet.map((l) => {
					return groups[l] ? /* @__PURE__ */ jsx("a", {
						href: `#letter-${l}`,
			...
			letters.map((letter) => /* @__PURE__ */ jsxs("div", {
				id: `letter-${letter}`,
				className: "mt-10 scroll-mt-32",
				children: [/* @__PURE__ */ jsx("h2", {
					className: "mb-4 text-sm font-bold uppercase tracking-widest text-accent",
					children: letter
				}), /* @__PURE__ */ jsx("dl", {
					className: "grid gap-6 sm:grid-cols-2",
					children: groups[letter].map((t) => /* @__PURE__ */ jsxs("div", {
