...
//#region src/assets/team/vimal.jpg
var vimal_default = "/assets/vimal-DKl1rEnn.jpg";
//#endregion
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: [
						/* @__PURE__ */ jsx("span", {
							...
							children: "Operator-built. Operator-run. Since 2007."
						}),
						/* @__PURE__ */ jsxs("h1", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("span", {
									...
									children: "before we sold it to yours."
								})
							]
						}),
						/* @__PURE__ */ jsx("p", {
							className: "mx-auto mt-5 max-w-2xl text-lg text-muted-foreground",
							children: "Innrly has been running Q Hotels Management's portfolio — across Hilton, Marriott, IHG, and Best Western properties — since 2007. We released it to other operators in 2023."
						})
					]
				})]
			}),
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsx("div", {
					className: "mx-auto grid max-w-7xl grid-cols-1 gap-4 px-4 py-6 sm:grid-cols-3 sm:gap-6 sm:px-6 lg:px-8",
					children: RECEIPTS.map((r) => /* @__PURE__ */ jsxs("div", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", {
								className: "h-16 w-16 shrink-0 overflow-hidden rounded-full border border-border bg-gradient-to-br from-surface to-card",
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: "Vimal Patel"
								}), /* @__PURE__ */ jsx("div", {
									className: "text-xs text-muted-foreground",
									children: "Founder, Innrly · Q Hotels Management"
								})]
							})]
						}),
						/* @__PURE__ */ jsxs("div", {
						...
						/* @__PURE__ */ jsxs("figure", {
							className: "relative mt-10 rounded-2xl border border-accent/30 bg-card/60 p-6 sm:p-8",
							children: [
								/* @__PURE__ */ jsx(Quote, {
								...
								/* @__PURE__ */ jsx("blockquote", {
									...
									children: "\"Every hotel loses money in the small places no one is watching. I built Innrly to watch them — with an owner's mindset, at the scale of a portfolio. Micro discipline, macro reach.\""
								}),
								/* @__PURE__ */ jsxs("figcaption", {
									className: "mt-5 border-t border-border/60 pt-4 text-sm",
									children: [/* @__PURE__ */ jsx("span", {
										className: "font-semibold text-foreground",
										children: "Vimal Patel"
									}), /* @__PURE__ */ jsxs("span", {
			...
			/* @__PURE__ */ jsxs(Section, {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						children: "You're buying something that's already survived 19 years of real hotels."
					})]
				}), /* @__PURE__ */ jsx("ul", {
					className: "mx-auto mt-10 grid max-w-5xl gap-4 md:grid-cols-3",
					children: TRANSLATOR.map((line) => /* @__PURE__ */ jsxs("li", {
			...
			/* @__PURE__ */ jsxs(Section, {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						children: "From one hotel's pain to a platform for 200+."
					})]
				}), /* @__PURE__ */ jsx("ol", {
					className: "relative mx-auto mt-12 max-w-3xl space-y-8 border-l border-border/60 pl-8",
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 lg:px-8",
					children: [
						/* @__PURE__ */ jsx("h2", {
							className: "text-3xl font-semibold text-foreground sm:text-4xl",
							children: "Run your back office the way an operator would."
						}),
						/* @__PURE__ */ jsx("p", {
							className: "mx-auto mt-3 max-w-xl text-base text-muted-foreground",
							children: "See Innrly with your portfolio. 30-minute demo, no pitch deck — or skip ahead and start your 90-day trial."
						}),
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Button, {
								...
								children: /* @__PURE__ */ jsx(Link, {
									to: "/onboarding",
									children: "Start the 90-day trial"
								})
							})]
						})
					]
