...
import { n as defaultSeoData, r as fetchSeoData } from "./seo-DZAr2mfV.js";
...
function ControlHubSeoPage() {
	...
	async function loadPageData(path) {
		...
		if (serverData && serverData.title) setData({
			...serverData,
			in_sitemap: serverData.in_sitemap !== void 0 ? Boolean(serverData.in_sitemap) : true,
			priority: serverData.priority || "0.8",
			changefreq: serverData.changefreq || "monthly"
		});
		else setData({
			...defaultSeoData[path] ? { ...defaultSeoData[path] } : {
				page_path: path,
				title: ""
			},
			in_sitemap: true,
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("code", {
								className: "bg-slate-100 px-1 py-0.5 rounded text-indigo-600 font-mono",
								children: "https://www.innrly.com/robots.txt"
							}),
							"."
						]
					})] }), /* @__PURE__ */ jsxs("div", {
