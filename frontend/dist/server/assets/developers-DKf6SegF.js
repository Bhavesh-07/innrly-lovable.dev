...
import { BookText, Code2, Plug, Webhook } from "lucide-react";
//#region src/routes/developers.tsx?tsr-split=component
var blocks = [
	{
		icon: Code2,
		t: "REST API",
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("p", {
							...
							children: "Innrly exposes secure REST APIs and webhooks for hotel data — invoices, GL, labor, reservations, and reconciliation. Built for portfolios, accounting partners, and integrators."
						})
					]
				})]
			}),
			/* @__PURE__ */ jsxs(Section, { children: [/* @__PURE__ */ jsx(SectionHeading, {
				...
				title: "APIs, webhooks, and partner tooling."
			}), /* @__PURE__ */ jsx("div", {
				className: "mt-10 grid gap-6 md:grid-cols-2",
				children: blocks.map((b) => /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsx(Section, {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("p", {
							className: "text-xs font-semibold uppercase tracking-widest text-accent",
							children: "Sample · Webhook payload"
						}),
						/* @__PURE__ */ jsx("pre", {
							className: "mt-4 overflow-x-auto rounded-lg border border-border/60 bg-background/50 p-4 text-xs leading-relaxed text-foreground",
							children: `POST https://your-app.example.com/innrly
...

{
  ...
  "data": {
    ...
    "posted_to": "quickbooks_online"
						...
						/* @__PURE__ */ jsx("p", {
							className: "mt-6 text-xs font-semibold uppercase tracking-widest text-accent",
							children: "Expected response"
						}),
						/* @__PURE__ */ jsx("pre", {
							className: "mt-3 overflow-x-auto rounded-lg border border-border/60 bg-background/50 p-4 text-xs leading-relaxed text-foreground",
...
{ "received": true }`
						...
						/* @__PURE__ */ jsx("p", {
							...
							children: "Respond with 2xx within 10 seconds. Non-2xx or timeouts trigger automatic retry with exponential backoff for up to 24 hours."
						}),
						/* @__PURE__ */ jsx("p", {
							className: "mt-6 text-xs font-semibold uppercase tracking-widest text-accent",
							children: "Verify the signature"
						}),
						/* @__PURE__ */ jsx("pre", {
							className: "mt-3 overflow-x-auto rounded-lg border border-border/60 bg-background/50 p-4 text-xs leading-relaxed text-foreground",
...
export function verifyInnrlySignature(
  ...
  return a.length === b.length && crypto.timingSafeEqual(a, b);
						...
						/* @__PURE__ */ jsx("p", {
							className: "mt-2 text-xs text-muted-foreground",
							children: "Always verify against the raw request body — JSON-stringifying after parse will break the HMAC. Rotate webhook secrets from the partner dashboard; both old and new secrets verify for 24 hours after rotation."
						})
					]
				})
			}),
