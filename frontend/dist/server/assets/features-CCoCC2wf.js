...
import { AlertTriangle, ArrowRight, BadgeCheck, BarChart3, Calendar, Check, Clock, CreditCard, FileText, LineChart, Lock, Mail, PlugZap, Receipt, ScanLine, ShieldCheck, Smartphone, Sunrise, Users, Wallet, Workflow } from "lucide-react";
//#region src/components/site/DailyLaborSnapshot.tsx
/**
		...
		children: [
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: "Innrly Shift · Daily snapshot · 11:42 AM"
						}),
						/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "grid grid-cols-4 gap-2 rounded-xl border border-border/60 bg-surface/60 p-3",
							children: [
								/* @__PURE__ */ jsx(Kpi, {
									label: "Labor %",
									value: "29.4%",
						...
						/* @__PURE__ */ jsxs("div", {
							className: "mt-3 rounded-xl border border-border/60 bg-surface/60 p-3",
							children: [/* @__PURE__ */ jsxs("div", {
								className: "flex items-center justify-between border-b border-border/40 pb-2",
								children: [/* @__PURE__ */ jsx("span", {
									className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground",
									children: "Housekeeping · 18 rooms attendants"
								}), /* @__PURE__ */ jsx("span", {
									className: "text-[9px] text-muted-foreground",
									children: "vs occupancy 82%"
								})]
							}), /* @__PURE__ */ jsxs("div", {
								className: "mt-2 space-y-1.5",
								children: [
									/* @__PURE__ */ jsx(Attendant, {
										name: "M. Reyes",
										rooms: 14,
										mpor: 23.1,
										pct: 92,
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								className: "rounded-xl border border-chart-4/30 bg-chart-4/5 p-3",
								children: [
									/* @__PURE__ */ jsxs("div", {
										className: "flex items-center gap-2",
										children: [/* @__PURE__ */ jsx(AlertTriangle, { className: "h-3.5 w-3.5 text-chart-4" }), /* @__PURE__ */ jsx("span", {
											className: "text-[10px] font-bold uppercase tracking-wider text-chart-4",
											children: "OT guardrail"
										})]
									}),
									/* @__PURE__ */ jsx("div", {
										className: "mt-2 text-[11px] font-semibold text-foreground",
										children: "D. Cole · 38.5 / 40 hrs"
									}),
									/* @__PURE__ */ jsx("div", {
										className: "mt-0.5 text-[10px] text-muted-foreground",
										children: "Flagged at clock-in · GM notified"
									})
								]
							}), /* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										className: "flex items-center gap-2",
										children: [/* @__PURE__ */ jsx(Clock, { className: "h-3.5 w-3.5 text-accent" }), /* @__PURE__ */ jsx("span", {
											className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground",
											children: "Face-ID clock-ins"
										})]
									}),
									/* @__PURE__ */ jsxs("div", {
									...
									/* @__PURE__ */ jsx("div", {
										...
										children: "No buddy-punches today"
									})
								]
							})]
						})
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: "GM mobile · 5 min"
				}), /* @__PURE__ */ jsx("div", {
					className: "text-lg font-bold text-foreground",
					children: "Done before lunch"
				})]
			})
		]
	});
}
function Kpi({ label, value, sub, good, warn }) {
	return /* @__PURE__ */ jsxs("div", {
...
function Attendant({ name, rooms, mpor, pct, good, warn }) {
	return /* @__PURE__ */ jsxs("div", {
		className: "flex items-center gap-2",
		children: [
			/* @__PURE__ */ jsx("span", {
				className: "w-20 text-[10px] font-semibold text-foreground",
				children: name
			}),
			/* @__PURE__ */ jsxs("span", {
			...
			/* @__PURE__ */ jsxs("span", {
				className: "w-14 text-[10px] text-muted-foreground",
				children: [mpor, " mpor"]
			}),
			/* @__PURE__ */ jsx("div", {
...
function Stage({ stage, index }) {
	...
	return /* @__PURE__ */ jsx(Section, { children: /* @__PURE__ */ jsxs(Reveal, { children: [/* @__PURE__ */ jsxs("div", {
		className: "relative",
		children: [/* @__PURE__ */ jsx("span", {
			"aria-hidden": true,
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					className: "flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-cta",
					children: /* @__PURE__ */ jsx(stage.icon, {
				...
				className: "rounded-2xl border border-accent/30 bg-accent/5 px-4 py-2 text-right",
				children: [/* @__PURE__ */ jsx("div", {
					className: "text-2xl font-bold text-gradient",
					children: stage.outcome.stat
				}), /* @__PURE__ */ jsx("div", {
					className: "text-[11px] font-medium uppercase tracking-wider text-muted-foreground",
					children: stage.outcome.label
				})]
			})]
		})]
	}), /* @__PURE__ */ jsxs("div", {
		className: `mt-8 grid gap-8 lg:grid-cols-2 lg:items-start ${reverse ? "lg:[&>*:first-child]:order-2" : ""}`,
		children: [
			/* @__PURE__ */ jsxs("div", {
				className: "hidden lg:block",
				children: [/* @__PURE__ */ jsx("ul", {
					className: "divide-y divide-border/60 rounded-2xl border border-border/60 bg-card/40",
					children: stage.items.map((it) => /* @__PURE__ */ jsxs("li", {
						...
						children: [/* @__PURE__ */ jsx(it.icon, {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("h3", {
									...
									children: it.name
								}), it.plan && /* @__PURE__ */ jsx("span", {
									className: "inline-flex shrink-0 items-center rounded-full border border-accent/40 bg-accent/10 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-accent",
									children: it.plan
								})]
							}), /* @__PURE__ */ jsx("p", {
					...
					children: [stage.link.label, /* @__PURE__ */ jsx(ArrowRight, {
						className: "h-4 w-4",
						"aria-hidden": true
					})]
				})]
			...
			/* @__PURE__ */ jsx("div", {
				className: "relative",
				children: /* @__PURE__ */ jsx("div", {
					className: "relative overflow-hidden rounded-2xl border border-border/60 bg-card/60 p-4 shadow-[0_20px_60px_-30px_color-mix(in_oklab,var(--accent)_60%,transparent)] sm:p-6",
					children: /* @__PURE__ */ jsx(Artifact, {})
				})
			}),
			/* @__PURE__ */ jsxs("div", {
				className: "lg:hidden",
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: stage.items.map((it) => /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(it.icon, {
									...
									className: "inline-flex items-center rounded-full border border-accent/40 bg-accent/10 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-accent",
									children: it.plan
								})]
							}),
							/* @__PURE__ */ jsx("h3", {
	...
	return /* @__PURE__ */ jsx(Section, {
		...
		children: /* @__PURE__ */ jsxs(Reveal, { children: [/* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
				...
				className: "mt-1 text-2xl font-bold text-foreground sm:text-3xl",
				children: "Table-stakes, table-set."
			})] })
		}), /* @__PURE__ */ jsx("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: [/* @__PURE__ */ jsxs("h1", {
						...
						children: ["Everything you need to ", /* @__PURE__ */ jsx("span", {
							...
							children: "run a hotel portfolio."
						})]
					}), /* @__PURE__ */ jsx("p", {
						className: "mt-4 text-lg text-muted-foreground",
						children: "Four core suites, plus mobile, security, and two add-ons — Innrly Pay and Innrly Shift. Built for hospitality from day one."
					})]
				})]
			}),
			stages.map((s, i) => /* @__PURE__ */ jsx(Stage, {
				stage: s,
				index: i
			}, s.title)),
			/* @__PURE__ */ jsx(AlsoIncluded, {}),
			/* @__PURE__ */ jsx(Section, { children: /* @__PURE__ */ jsxs(Reveal, { children: [/* @__PURE__ */ jsxs("div", {
				className: "flex items-center gap-3",
				children: [/* @__PURE__ */ jsx("div", {
					className: "flex h-11 w-11 items-center justify-center rounded-xl bg-cta",
					...
					children: "Two add-ons"
				}), /* @__PURE__ */ jsx("p", {
					className: "mt-1 text-sm text-muted-foreground",
					children: "Bolt these onto any plan — or get Innrly Pay free with Professional Annual."
				})] })]
			}), /* @__PURE__ */ jsx("div", {
				className: "mt-8 grid gap-5 md:grid-cols-2",
				children: addOns.map((a) => /* @__PURE__ */ jsxs(Link, {
					to: a.to,
					className: "group flex flex-col rounded-2xl border border-accent/30 bg-card p-6 transition-colors hover:border-accent/60",
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-3",
							children: [/* @__PURE__ */ jsx(a.icon, {
