...
//#region src/components/site/CompareLayout.tsx
function Cell({ value }) {
	...
	if (value === "partial") return /* @__PURE__ */ jsx(Minus, {
...
function CompareLayout({ competitorName, eyebrow, title, intro, summary, rows, whenToChoose, faqs }) {
		...
		children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Button, {
								...
								children: /* @__PURE__ */ jsx(Link, {
									to: "/contact",
									children: "See Innrly on your data"
								})
							}), /* @__PURE__ */ jsx(Button, {
								asChild: true,
								size: "lg",
			...
			/* @__PURE__ */ jsxs(Section, {
				...
				children: [/* @__PURE__ */ jsx(SectionHeading, {
					...
					children: summary.map((s) => /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: rows.map((r) => /* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									className: "flex flex-col justify-center border-b border-border px-5 py-4 md:border-b-0 md:border-r",
									children: [/* @__PURE__ */ jsx("p", {
										className: "text-sm font-semibold text-foreground",
										children: r.feature
									}), r.note && /* @__PURE__ */ jsx("p", {
										className: "mt-1 text-xs text-muted-foreground",
										children: r.note
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "flex items-center gap-3 border-b border-border bg-accent/[0.06] px-5 py-4 md:border-b-0 md:border-r",
									children: [/* @__PURE__ */ jsx("span", {
										className: "text-[10px] font-semibold uppercase tracking-widest text-accent",
										children: "Innrly"
									}), /* @__PURE__ */ jsx("div", {
										className: "flex-1 text-sm font-medium text-foreground",
										children: /* @__PURE__ */ jsx(Cell, { value: r.innrly })
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "flex items-center gap-3 bg-muted/20 px-5 py-4",
									children: [/* @__PURE__ */ jsx("span", {
										className: "text-[10px] font-semibold uppercase tracking-widest text-muted-foreground",
										children: competitorName
									}), /* @__PURE__ */ jsx("div", {
										className: "flex-1 text-sm text-muted-foreground",
										children: /* @__PURE__ */ jsx(Cell, { value: r.competitor })
									})]
								})
							]
						}, r.feature))
			...
			/* @__PURE__ */ jsxs(Section, {
				className: "py-12",
				children: [/* @__PURE__ */ jsx(SectionHeading, {
					eyebrow: "Why choose Innrly",
					title: "Reasons operators pick Innrly."
				}), /* @__PURE__ */ jsx("div", {
					className: "mt-10 grid gap-4 md:grid-cols-2",
					children: whenToChoose.innrly.map((i) => /* @__PURE__ */ jsxs("div", {
