...
import { BarChart3, Calendar, Mail, TrendingDown, TrendingUp } from "lucide-react";
//#region src/components/site/BIMorningBriefing.tsx
/**
...
function Row({ label, value, delta, up }) {
	return /* @__PURE__ */ jsxs("div", {
...
function CompRow({ name, delta, down, highlight }) {
	return /* @__PURE__ */ jsxs("div", {
