...
import { t as Route } from "./solutions.business-intelligence-B5lFX7WU.js";
import { t as BIMorningBriefing } from "./BIMorningBriefing-BGplposB.js";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { AlertCircle, ArrowRight, BarChart3, Building2, Calendar, Check, Coffee, Eye, FileText, LineChart, Mail, MessageSquare, StickyNote, TrendingDown, TrendingUp, X } from "lucide-react";
//#region src/components/site/BIChaos.tsx
/**
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "grid grid-cols-[1fr_56px_70px] gap-1 text-muted-foreground",
							children: [
						...
						/* @__PURE__ */ jsxs("div", {
							className: "grid grid-cols-[1fr_56px_70px] gap-1 text-foreground",
							children: [
								/* @__PURE__ */ jsx("span", {
									className: "truncate",
									children: "DAL-12 Night Audit"
								}),
								/* @__PURE__ */ jsx("span", { children: "PDF" }),
								/* @__PURE__ */ jsx("span", {
									className: "rounded bg-success/15 px-1 text-center text-success",
									children: "8:42 AM"
								})
							]
						}),
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("span", {
									className: "truncate",
									children: "AUS-03 Daily Flash"
								}),
								/* @__PURE__ */ jsx("span", { children: "XLSX" }),
								/* @__PURE__ */ jsx("span", {
									className: "rounded bg-chart-4/20 px-1 text-center text-chart-4",
									children: "9:15 AM"
								})
							]
						}),
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("span", {
									className: "truncate",
									children: "HOU-07 Pacing"
								}),
								/* @__PURE__ */ jsx("span", { children: "—" }),
								/* @__PURE__ */ jsx("span", {
									className: "rounded bg-destructive/20 px-1 text-center text-destructive",
									children: "missing"
								})
							]
						})
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(MessageSquare, { className: "h-3 w-3 text-primary" }), /* @__PURE__ */ jsx("span", {
								className: "truncate text-[10px] font-semibold text-foreground",
								children: "#owners · 4:51 AM"
							})]
						}), /* @__PURE__ */ jsxs("div", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(StickyNote, { className: "h-3 w-3" }), /* @__PURE__ */ jsx("span", { children: "STR ??" })]
						}), /* @__PURE__ */ jsx("div", {
							className: "mt-0.5 text-[9px] font-normal",
							children: "pull manually"
						})]
					})
				]
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(AlertCircle, { className: "h-3 w-3 shrink-0 text-destructive" }), /* @__PURE__ */ jsx("span", {
					...
					children: "Decisions delayed · coffee already cold"
				})]
			})
		]
	});
...
//#endregion
//#region src/components/site/BIFlow.tsx
/**
		...
		children: [
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: "Innrly · Owner view · 5:02 AM"
						}),
						/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(Mail, { className: "h-3.5 w-3.5 text-accent" }), /* @__PURE__ */ jsx("span", {
									...
									children: "Early Bird · 5 AM digest"
								})]
							}),
							/* @__PURE__ */ jsxs("div", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: "Pacing alert"
								}), /* @__PURE__ */ jsx("div", {
									className: "mt-0.5 text-[11px] font-semibold text-foreground",
									children: "AUS-03 weekend pace +14% vs LY"
								})]
							})
						]
					}), /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("span", {
										className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground",
										children: "Pulse · 8 properties"
									}),
									/* @__PURE__ */ jsx("span", {
										className: "ml-auto text-[9px] text-muted-foreground",
										children: "refreshed 4:58 AM"
									})
								]
							}), /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx(Calendar, { className: "h-3.5 w-3.5 text-accent" }), /* @__PURE__ */ jsx("span", {
											className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground",
											children: "STR Index"
										})]
									}),
									...
									/* @__PURE__ */ jsx("div", {
										...
										children: "RevPAR Index · vs comp set"
									}),
									/* @__PURE__ */ jsx("div", {
										className: "mt-2 flex h-6 items-end gap-0.5",
										children: [
											5,
											7,
											6,
								...
								children: [/* @__PURE__ */ jsxs("div", {
									className: "flex items-center gap-2",
									children: [/* @__PURE__ */ jsx(TrendingDown, { className: "h-3.5 w-3.5 text-chart-4" }), /* @__PURE__ */ jsx("span", {
										className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground",
										children: "Rate Shop"
									})]
								}), /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: "Before your coffee"
				}), /* @__PURE__ */ jsx("div", {
					className: "text-lg font-bold text-foreground",
					children: "Portfolio decided"
				})]
			})
		]
	}, playKey);
}
function Row({ label, value, delta, up, delay }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("span", {
			...
			children: [/* @__PURE__ */ jsx("span", {
				...
				className: `text-[10px] font-semibold ${up ? "text-success" : "text-destructive"}`,
				children: delta
			})]
		})]
	});
...
function CompRow({ name, delta, down, highlight, delay }) {
	return /* @__PURE__ */ jsxs("div", {
...
//#endregion
//#region src/routes/solutions.business-intelligence.tsx?tsr-split=component
var morningRail = [
	{
		time: "4:47 AM",
...
function Page() {
	...
	const t = allTestimonials.find((t) => t.page === "business-intelligence");
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					className: "relative mx-auto grid max-w-7xl gap-10 px-4 py-20 sm:px-6 lg:grid-cols-12 lg:px-8 lg:py-24",
					children: [/* @__PURE__ */ jsxs("div", {
						className: "lg:col-span-6",
						children: [
							/* @__PURE__ */ jsxs("div", {
								className: "inline-flex items-center gap-2 rounded-full border-2 border-accent/50 bg-accent/10 px-3.5 py-1.5 text-xs font-bold uppercase tracking-wider text-accent",
							...
							/* @__PURE__ */ jsx("div", {
								className: "mt-2 text-xs font-bold uppercase tracking-wider text-muted-foreground",
								children: "Hotel Business Intelligence"
							}),
							/* @__PURE__ */ jsxs("h1", {
								className: "mt-5 text-4xl font-bold leading-tight text-foreground sm:text-5xl",
								children: ["Your whole portfolio, ", /* @__PURE__ */ jsx("span", {
									className: "text-gradient",
									children: "before your first coffee."
								})]
							}),
							/* @__PURE__ */ jsxs("p", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(Button, {
									...
									children: /* @__PURE__ */ jsxs(Link, {
										to: "/contact",
										children: ["See your portfolio on Innrly ", /* @__PURE__ */ jsx(ArrowRight, { className: "ml-1.5 h-4 w-4" })]
									})
								}), /* @__PURE__ */ jsx(Button, {
									asChild: true,
									size: "lg",
						...
						className: "lg:col-span-6",
						children: [/* @__PURE__ */ jsx("div", {
							className: "mb-6 flex items-center justify-center lg:justify-end",
			...
			/* @__PURE__ */ jsxs(Section, {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("p", {
						...
						children: "From 4:47 AM scramble to 5:02 AM decided"
					}), /* @__PURE__ */ jsx("h2", {
						className: "mt-2 text-2xl font-bold text-foreground sm:text-3xl",
						children: "Watch the morning briefing assemble itself in 6 seconds."
					})]
				}), /* @__PURE__ */ jsx("div", {
					className: "mx-auto max-w-6xl",
					children: /* @__PURE__ */ jsx(BeforeAfterFlow, {
						chaos: /* @__PURE__ */ jsx(BIChaos, {}),
						after: (playKey) => /* @__PURE__ */ jsx(BIFlow, { playKey }),
						motion: "expenses"
					})
				})]
			}),
			/* @__PURE__ */ jsx(Section, { children: /* @__PURE__ */ jsxs("div", {
				className: "mx-auto max-w-4xl rounded-3xl border-2 border-accent/40 bg-card p-10 text-center shadow-[0_18px_55px_-30px_color-mix(in_oklab,var(--accent)_60%,transparent)] sm:p-14",
				children: [
					/* @__PURE__ */ jsx("div", {
						className: "mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-accent/15 text-accent",
						children: /* @__PURE__ */ jsx(Eye, { className: "h-6 w-6" })
					}),
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: t ? [
							...
							t.title,
							t.company
						].filter(Boolean).join(" · ") : "VP of Operations · 8-property midwest portfolio"
					}),
					/* @__PURE__ */ jsx("div", {
						className: "mt-6",
						children: /* @__PURE__ */ jsx(Button, {
							...
							children: /* @__PURE__ */ jsxs(Link, {
								...
								children: ["Read the full story ", /* @__PURE__ */ jsx(ArrowRight, { className: "ml-1.5 h-4 w-4" })]
							})
						})
					})
				]
			...
			/* @__PURE__ */ jsxs(Section, {
				...
				children: [/* @__PURE__ */ jsx(SectionHeading, {
					...
					title: /* @__PURE__ */ jsxs(Fragment, { children: ["What happens ", /* @__PURE__ */ jsx("span", {
						className: "text-gradient",
						children: "before you're awake."
					})] }),
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: morningRail.map((m, i) => /* @__PURE__ */ jsxs("div", {
								className: "relative",
								children: [
									/* @__PURE__ */ jsx("div", {
										className: "mx-auto flex h-14 w-14 items-center justify-center rounded-full border-2 border-accent/60 bg-background text-[11px] font-bold text-accent shadow-elevated",
										children: m.time.split(" ")[0]
									}),
									/* @__PURE__ */ jsxs("div", {
									...
									i < morningRail.length - 1 && /* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsxs(Section, { children: [/* @__PURE__ */ jsx(SectionHeading, {
				...
				title: /* @__PURE__ */ jsxs(Fragment, { children: ["How owners ", /* @__PURE__ */ jsx("span", {
					className: "text-gradient",
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx(BIMorningBriefing, {})
				})]
			})] }),
			/* @__PURE__ */ jsxs(Section, {
				tone: "surface",
				children: [/* @__PURE__ */ jsx(SectionHeading, {
					...
					title: /* @__PURE__ */ jsxs(Fragment, { children: ["What Innrly BI ", /* @__PURE__ */ jsx("span", {
						className: "text-gradient",
						children: "replaces."
					})] }),
					...
					children: [
						...
						children: [/* @__PURE__ */ jsx(X, { className: "h-3.5 w-3.5 text-destructive" }), /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs(Section, { children: [/* @__PURE__ */ jsx(SectionHeading, {
				...
				title: /* @__PURE__ */ jsxs(Fragment, { children: ["The modules ", /* @__PURE__ */ jsx("span", {
					className: "text-gradient",
					children: "behind the dashboard."
				})] }),
			...
			/* @__PURE__ */ jsxs(Section, {
				...
				children: [/* @__PURE__ */ jsx(SectionHeading, {
					...
					title: /* @__PURE__ */ jsxs(Fragment, { children: ["What owners ", /* @__PURE__ */ jsx("span", {
						className: "text-gradient",
					...
					].map((f) => /* @__PURE__ */ jsx("div", {
						className: "rounded-2xl border-2 border-accent/35 bg-card p-6 transition-colors hover:border-accent/65",
						children: /* @__PURE__ */ jsxs("div", {
							className: "flex items-start gap-3",
							children: [/* @__PURE__ */ jsx(Building2, { className: "mt-0.5 h-5 w-5 shrink-0 text-accent" }), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
								className: "text-base font-semibold text-foreground",
								children: f.q
							}), /* @__PURE__ */ jsx("p", {
								className: "mt-2 text-sm text-muted-foreground",
