...
import { ArrowRight, Building2, Check, ClipboardCheck, FileSpreadsheet, Leaf, PenLine } from "lucide-react";
//#region src/routes/services.accountability-pack.tsx?tsr-split=component
var services = [
	{
		icon: ClipboardCheck,
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("p", {
							...
							children: "The Accountability Pack is an optional per-property add-on. Our team handles the data verification, franchise filings, and manual entries your in-house staff doesn't have time for — using the same Innrly platform you already trust."
						}),
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Button, {
								...
								children: /* @__PURE__ */ jsxs(Link, {
									to: "/contact",
									children: ["Contact sales for pricing", /* @__PURE__ */ jsx(ArrowRight, { className: "ml-1.5 h-4 w-4" })]
								})
							}), /* @__PURE__ */ jsx(Button, {
								asChild: true,
								size: "lg",
								...
								children: /* @__PURE__ */ jsx(Link, {
									to: "/pricing",
									children: "View Innrly plans"
								})
							})]
						}),
						/* @__PURE__ */ jsx("p", {
							className: "mt-4 text-xs text-muted-foreground",
							children: "Per-property pricing varies by portfolio mix and service scope."
						})
					]
				})]
			}),
			...
			/* @__PURE__ */ jsxs(Section, {
				...
				children: [/* @__PURE__ */ jsx(SectionHeading, {
					...
					children: [
						...
						className: "flex items-start gap-3 aurora-card rounded-xl p-4",
