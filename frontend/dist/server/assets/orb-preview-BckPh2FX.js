...
//#region src/routes/orb-preview.tsx?tsr-split=component
var variants = [
	{
		id: "reconciliation",
		name: "Reconciliation",
...
function OrbPreviewPage() {
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				className: "mb-12 flex items-center justify-between border-b border-border/40 pb-6",
				children: [/* @__PURE__ */ jsxs("div", { children: [
					...
					/* @__PURE__ */ jsx("h1", {
						...
						children: "Product Orbs"
					}),
					/* @__PURE__ */ jsx("p", {
						className: "mt-2 text-muted-foreground",
						children: "Signature visual identity system for core and supporting Innrly solutions."
					})
				] }), /* @__PURE__ */ jsx(Button, {
					asChild: true,
					variant: "outline",
					...
					children: /* @__PURE__ */ jsxs(Link, {
						to: "/",
						children: [/* @__PURE__ */ jsx(ArrowLeft, { className: "mr-2 h-4 w-4" }), "Back to Home"]
					})
				})]
			}), /* @__PURE__ */ jsx("div", {
				className: "space-y-12",
				children: variants.map((v) => /* @__PURE__ */ jsxs("div", {
					className: "rounded-2xl border border-border/40 bg-surface/30 p-6 md:p-8 backdrop-blur",
					children: [/* @__PURE__ */ jsxs("div", {
						className: "mb-6 flex flex-col md:flex-row md:items-center md:justify-between border-b border-border/20 pb-4",
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
							...
							className: "mt-2 md:mt-0 text-xs font-mono text-accent",
							children: [
								"variant=\"",
								v.id,
								"\""
						...
						className: "grid grid-cols-1 gap-8 md:grid-cols-3 items-center justify-items-center",
						children: [
							/* @__PURE__ */ jsxs("div", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsx(ProductOrb, {
										...
										size: "lg",
										label: v.name,
										eyebrow: "Signature Upgrade",
										sublabel: "All systems nominal"
									})
								}), /* @__PURE__ */ jsx("div", {
									className: "text-xs font-mono text-muted-foreground",
									children: "size=\"lg\" (360px)"
								})]
							})
						]
					})]
...
//#endregion
export { OrbPreviewPage as component };
