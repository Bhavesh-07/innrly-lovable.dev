...
import { AlertCircle, Calendar, Cpu, FileCheck2, Moon } from "lucide-react";
//#region src/routes/hotel-back-office-automation.tsx?tsr-split=component
function Page() {
		...
		children: [/* @__PURE__ */ jsxs(Section, {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("p", {
					...
					children: "Integrated Hotel operations"
				}), /* @__PURE__ */ jsx("h2", {
					className: "mt-2 text-2xl font-bold text-foreground sm:text-3xl",
					children: "Triage variance across properties in under 60 seconds."
				})]
			}), /* @__PURE__ */ jsx("div", {
				className: "mx-auto max-w-6xl",
				children: /* @__PURE__ */ jsx(BeforeAfterFlow, {
					chaos: /* @__PURE__ */ jsx(ExceptionsLedger, {}),
			...
			beforeAfter: {
				title: /* @__PURE__ */ jsxs(Fragment, { children: [
					...
					/* @__PURE__ */ jsx("span", {
						className: "text-gradient",
						children: "automated back office."
					})
				] }),
			...
			workflow: {
				title: /* @__PURE__ */ jsxs(Fragment, { children: ["A day in the life of ", /* @__PURE__ */ jsx("span", {
					className: "text-gradient",
					children: "an automated hotel group."
				})] }),
			...
			replaces: {
				title: /* @__PURE__ */ jsxs(Fragment, { children: ["What Innrly ", /* @__PURE__ */ jsx("span", {
					className: "text-gradient",
			...
			faq: {
				title: /* @__PURE__ */ jsxs(Fragment, { children: ["What operators ", /* @__PURE__ */ jsx("span", {
					className: "text-gradient",
					children: "ask us."
				})] }),
				items: faqs
