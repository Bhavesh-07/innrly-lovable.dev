...
const posts: Record<string, { title: string; metaTitle?: string; date: string; body: string[] }> = {
  ...
  "labor-cost-blind-spots": {
    ...
    date: "2026-04-28",
    body: [
      "If you're only tracking labor as a percentage of revenue, you're missing the costs that actually move the needle. Here are three blind spots most operators have.",
      "Minutes-per-room. MPOR. And unauthorized overtime that accumulates across shifts. Each of these is invisible in a P&L but visible in a daily labor snapshot.",
    ],
  },
  "ota-commission-audit": {
    ...
    date: "2026-04-04",
    body: [
      "OTA commission audits are the most-skipped task in hotel finance because they're the most painful. Here's a repeatable monthly process you can hand to anyone on the team.",
...
export const Route = createFileRoute("/blog/$slug")({
  loader: async ({ params }) => {
    ...
    // 2. Fallback to pre-baked static posts dictionary if not in DB
    if (!post) {
    ...
    // 3. If neither dynamic nor static exists, 404
    if (!post) {
      throw notFound();
    }
...
type RelatedLink = { to: string; label: string; kind: "Solution" | "Industry" | "Case study" | "Guide" | "Compare" };

const DEFAULT_RELATED: RelatedLink[] = [
  { to: "/solutions/reconciliation", label: "Reconciliation engine", kind: "Solution" },
  { to: "/case-studies/midwest-portfolio", label: "12-hotel select-service case study", kind: "Case study" },
  { to: "/roi-calculator", label: "Calculate your portfolio ROI", kind: "Guide" },
];

const RELATED_BY_SLUG: Record<string, RelatedLink[]> = {
  "best-hotel-accounting-software": [
    { to: "/integrations/m3", label: "Innrly + M3 integration", kind: "Solution" },
    { to: "/integrations/inn-flow", label: "Innrly + Inn-Flow integration", kind: "Solution" },
    { to: "/blog/quickbooks-for-hotels-limits", label: "When operators outgrow QuickBooks", kind: "Guide" },
  ],
  "hotel-back-office-automation": [
    { to: "/solutions/reconciliation", label: "How the reconciliation engine works", kind: "Solution" },
    { to: "/industries/select-service", label: "Select-service back office", kind: "Industry" },
    { to: "/case-studies/midwest-portfolio", label: "12-hotel rollout case study", kind: "Case study" },
  ],
  "night-audit-automation": [
    { to: "/solutions/operations-automation", label: "Operations automation overview", kind: "Solution" },
    { to: "/blog/hotel-night-audit-checklist", label: "The 8-step night audit checklist", kind: "Guide" },
    { to: "/industries/select-service", label: "Select-service multi-brand audit", kind: "Industry" },
  ],
  "multi-property-accounting-software": [
    { to: "/integrations/m3", label: "Innrly + M3 integration", kind: "Solution" },
    { to: "/integrations/sage-intacct", label: "Innrly + Sage Intacct", kind: "Solution" },
    { to: "/blog/quickbooks-for-hotels-limits", label: "When operators outgrow QuickBooks", kind: "Guide" },
  ],
  "ap-automation-hotels": [
    { to: "/solutions/expense-entries", label: "A/P automation product", kind: "Solution" },
    { to: "/solutions/innrly-pay", label: "Innrly Pay (Virtual Card + ACH)", kind: "Solution" },
    { to: "/case-studies/hilton-management-company", label: "28-hotel A/P consolidation", kind: "Case study" },
  ],
  "hotel-labor-cost-percentage": [
    { to: "/solutions/labor-workforce", label: "Labor & workforce module", kind: "Solution" },
    { to: "/blog/mpor-explained", label: "MPOR explained", kind: "Guide" },
    { to: "/solutions/innrly-shift", label: "Innrly Shift TimeClock", kind: "Solution" },
  ],
  "innrly-vs-inn-flow": [
    { to: "/compare/innrly-vs-otelier", label: "Innrly: alternative to Otelier", kind: "Compare" },
    { to: "/pricing", label: "Innrly pricing", kind: "Guide" },
    { to: "/case-studies/midwest-portfolio", label: "12-hotel case study", kind: "Case study" },
  ],
  "hotel-night-audit-checklist": [
    { to: "/solutions/operations-automation", label: "Operations automation", kind: "Solution" },
    { to: "/industries/select-service", label: "Select-service portfolios", kind: "Industry" },
    { to: "/blog/night-audit-automation", label: "Automating the audit", kind: "Guide" },
  ],
  "hotel-ota-commission-reconciliation": [
    { to: "/solutions/reconciliation", label: "Reconciliation engine", kind: "Solution" },
    { to: "/blog/ota-reconciliation-guide", label: "OTA reconciliation deep-dive", kind: "Guide" },
    { to: "/roi-calculator", label: "Calculate recovered OTA revenue", kind: "Guide" },
  ],
  "pms-vs-back-office-automation": [
    { to: "/integrations/opera", label: "Innrly + Opera", kind: "Solution" },
    { to: "/integrations/cloudbeds", label: "Innrly + Cloudbeds", kind: "Solution" },
    { to: "/integrations/mews", label: "Innrly + Mews", kind: "Solution" },
  ],
  "hotel-budgeting-software-2026": [
    { to: "/solutions/business-intelligence", label: "Business Intelligence product", kind: "Solution" },
    { to: "/solutions/financial-control", label: "Financial Control suite", kind: "Solution" },
    { to: "/blog/multi-property-accounting-software", label: "Multi-property accounting guide", kind: "Guide" },
  ],
  "select-service-back-office-savings": [
    { to: "/industries/select-service", label: "Select-service industry page", kind: "Industry" },
    { to: "/case-studies/midwest-portfolio", label: "12-hotel case study", kind: "Case study" },
    { to: "/roi-calculator", label: "Run the ROI on your portfolio", kind: "Guide" },
  ],
  "mpor-explained": [
    { to: "/solutions/innrly-shift", label: "Innrly Shift workforce module", kind: "Solution" },
    { to: "/solutions/labor-workforce", label: "Labor & workforce overview", kind: "Solution" },
    { to: "/blog/hotel-labor-cost-percentage", label: "Hotel labor cost percentage", kind: "Guide" },
  ],
  "quickbooks-for-hotels-limits": [
    { to: "/integrations/quickbooks", label: "Innrly + QuickBooks integration", kind: "Solution" },
    { to: "/integrations/sage-intacct", label: "Step up to Sage Intacct", kind: "Solution" },
    { to: "/blog/multi-property-accounting-software", label: "Multi-property accounting buyer's guide", kind: "Guide" },
  ],
  "hospitality-accounting-services-vs-software": [
    { to: "/services/accountability-pack", label: "Innrly Accountability Pack", kind: "Solution" },
    { to: "/pricing", label: "Innrly pricing", kind: "Guide" },
    { to: "/roi-calculator", label: "ROI calculator", kind: "Guide" },
  ],
  "ota-reconciliation-guide": [
    { to: "/solutions/reconciliation", label: "Reconciliation engine", kind: "Solution" },
    { to: "/blog/hotel-ota-commission-reconciliation", label: "OTA commission recovery", kind: "Guide" },
    { to: "/case-studies/urban-full-service", label: "Urban full-service case study", kind: "Case study" },
  ],
  "hotel-night-audit-software-guide": [
    { to: "/solutions/operations-automation", label: "Operations automation product", kind: "Solution" },
    { to: "/blog/hotel-night-audit-checklist", label: "Night audit checklist", kind: "Guide" },
    { to: "/integrations/opera", label: "Innrly + Opera", kind: "Solution" },
  ],
  "multi-property-hotel-accounting-software": [
    { to: "/solutions/financial-control", label: "Financial Control suite", kind: "Solution" },
    { to: "/integrations/m3", label: "Innrly + M3", kind: "Solution" },
    { to: "/case-studies/hilton-management-company", label: "28-property Hilton case study", kind: "Case study" },
  ],
  "five-back-office-wins": [
    { to: "/solutions/operations-automation", label: "Operations automation", kind: "Solution" },
    { to: "/solutions/financial-control", label: "Financial Control", kind: "Solution" },
    { to: "/case-studies/midwest-portfolio", label: "12-hotel case study", kind: "Case study" },
  ],
  "labor-cost-blind-spots": [
    { to: "/solutions/labor-workforce", label: "Labor & workforce module", kind: "Solution" },
  ...
  "ota-commission-audit": [
    ...
    { to: "/roi-calculator", label: "Run the ROI", kind: "Guide" },
  ],
};
  ...
  return (
    <div className="bg-background">
      ...
      <Section className="max-w-3xl py-16">
        ...
        <h1 className="mt-6 text-4xl font-bold text-foreground sm:text-5xl leading-tight">
          {post.title}
        </h1>
        <div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-muted-foreground">
          <span className="font-medium text-foreground">{post.author || "The Innrly Team"}</span>
        ...
        {/* Content rendering: Rich HTML from CMS or Paragraph array from static */}
        {post.contentHtml ? (
          <div 
          ...
          <div className="mt-8 space-y-6 text-lg leading-relaxed text-muted-foreground">
            {post.body?.map((p: string, i: number) => {
              ...
              if (p.length < 60 && !p.endsWith(".") && !p.endsWith(":") && !p.includes(" — ") && !p.startsWith("1.") && !p.startsWith("2.") && !p.startsWith("3.") && !p.startsWith("4.") && !p.startsWith("5.") && !p.startsWith("6.")) {
                return (
        ...
        <aside className="mt-16 rounded-2xl border border-border bg-surface/40 p-6 sm:p-8">
          <p className="text-xs font-semibold uppercase tracking-widest text-accent">Keep reading</p>
          <h2 className="mt-2 text-xl font-semibold text-foreground">Related reading</h2>
          <ul className="mt-5 space-y-3">
            {related.map((r) => (
              <li key={r.to}>
                ...
                >
                  <span className="font-medium text-foreground group-hover:text-accent">{r.label}</span>
                  <span className="shrink-0 text-[10px] font-bold uppercase tracking-widest text-muted-foreground">{r.kind}</span>
                </a>
              </li>
            ))}
          </ul>
