  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-background", children: [
    ...
    /* @__PURE__ */ jsx(Section, { className: "py-16", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-3xl", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-6 flex items-center gap-4", children: [
        /* @__PURE__ */ jsx("div", { className: "h-16 w-16 shrink-0 overflow-hidden rounded-full border border-border bg-gradient-to-br from-surface to-card", children: /* @__PURE__ */ jsx("img", { src: vimalPortrait, alt: "Vimal Patel", className: "h-full w-full object-cover", loading: "lazy" }) }),
