...
import { FileSpreadsheet, Receipt, Mail, HelpCircle, AlertCircle, CreditCard, BookOpen, ArrowRight, Check, Repeat, Brain, ArrowDownToLine } from "lucide-react";
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 border-b border-border/40 pb-1", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-[10px] font-semibold text-foreground", children: "Expenses_Oct_v4.xlsx" }),
            /* @__PURE__ */ jsx("span", { className: "ml-auto text-[9px] text-muted-foreground", children: "14 rows · 8 uncoded" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mt-1 space-y-0.5 text-[9px]", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-[1fr_60px_60px] gap-1 text-muted-foreground", children: [
              /* @__PURE__ */ jsx("span", { children: "Vendor" }),
              /* @__PURE__ */ jsx("span", { children: "Amount" }),
              /* @__PURE__ */ jsx("span", { children: "GL" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-[1fr_60px_60px] gap-1 text-foreground", children: [
              /* @__PURE__ */ jsx("span", { className: "truncate", children: "Home Depot" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-[1fr_60px_60px] gap-1 text-foreground", children: [
              /* @__PURE__ */ jsx("span", { className: "truncate", children: "Reliant Energy" }),
              /* @__PURE__ */ jsx("span", { children: "$842.10" }),
              /* @__PURE__ */ jsx("span", { className: "rounded bg-destructive/15 px-1 text-center text-destructive", children: "???" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-[1fr_60px_60px] gap-1 text-foreground", children: [
              /* @__PURE__ */ jsx("span", { className: "truncate", children: "Coffee · F&B" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx(Receipt, { className: "h-3.5 w-3.5 shrink-0 text-primary" }),
            /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsx("div", { className: "truncate text-[10px] font-semibold text-foreground", children: "Amex •••• 2014" }),
              /* @__PURE__ */ jsx("div", { className: "text-[9px] text-muted-foreground", children: "14 charges · not in QB" })
            ] })
          ]
        }
      ),
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "truncate text-[10px] font-semibold text-foreground", children: "Auto-pay receipt" })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "mt-1 line-clamp-1 text-[9px] text-muted-foreground", children: '"Forwarded for your records…"' })
          ]
        }
      ),
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "mt-0.5 text-[9px] font-normal", children: "$87 run" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-[10px] font-semibold text-destructive", children: "QuickBooks out of sync · 11 days behind" })
        ]
      }
    )
  ] });
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-2xl border border-border bg-card shadow-elevated", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 border-b border-border/60 bg-surface/60 px-4 py-3", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "ml-3 text-xs font-medium text-muted-foreground", children: "Expense Entries · DAL-12" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative grid grid-cols-1 gap-3 p-4 md:grid-cols-5", children: [
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(CreditCard, { className: "h-4 w-4 text-accent" }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("div", { className: "text-[10px] font-bold text-foreground", children: "Home Depot" }),
                /* @__PURE__ */ jsx("div", { className: "text-[9px] text-muted-foreground", children: "$418.92 · Amex" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxs("div", { className: "relative col-span-2 rounded-xl border border-accent/40 bg-surface/60 p-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 border-b border-border/40 pb-2", children: [
            /* @__PURE__ */ jsx(Receipt, { className: "h-3.5 w-3.5 text-accent" }),
            /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground", children: "Quick entry" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mt-2 space-y-2 text-[11px]", children: [
            /* @__PURE__ */ jsx(AnimField, { label: "Vendor", value: "Home Depot", delay: "1.65s", memory: true }),
            /* @__PURE__ */ jsx(AnimField, { label: "Amount", value: "$418.92", delay: "2.05s" }),
            /* @__PURE__ */ jsx(AnimField, { label: "Date", value: "Oct 18", delay: "2.25s" }),
            /* @__PURE__ */ jsx(AnimField, { label: "GL Code", value: "5410 · R&M", delay: "2.55s", memory: true }),
            /* @__PURE__ */ jsx(AnimField, { label: "Card / Paid by", value: "Amex •••• 2014", delay: "2.85s" })
          ] }),
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider text-accent", children: "Vendor memory" }),
                /* @__PURE__ */ jsx("span", { className: "text-[10px] font-semibold text-foreground", children: "2 fields prefilled" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "ba-landing-glow col-span-3 space-y-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border/60 bg-surface/60 p-3", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 border-b border-border/40 pb-2", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground", children: "Today's expenses" }),
              /* @__PURE__ */ jsx("span", { className: "ml-auto text-[9px] font-semibold text-foreground", children: "$2,184.27" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mt-2 space-y-1", children: [
              ...
              /* @__PURE__ */ jsx(ExpRow, { vendor: "Comcast", gl: "6230 · Internet", amount: "$219.99", status: "paid" }),
              /* @__PURE__ */ jsx(ExpRow, { vendor: "Coffee · F&B run", gl: "5120 · F&B", amount: "$87.40", status: "paid" }),
              /* @__PURE__ */ jsx(
                ExpRow,
                {
          ...
          /* @__PURE__ */ jsx("div", { className: "rounded-xl border border-border/60 bg-surface/60 p-3", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2", children: [
            /* @__PURE__ */ jsx(FlowStep, { label: "Innrly", sub: "Entered", delay: "4.15s" }),
            /* @__PURE__ */ jsx(ArrowRight, { className: "h-3 w-3 text-muted-foreground" }),
            /* @__PURE__ */ jsx(FlowStep, { label: "GL coded", sub: "Vendor memory", delay: "4.55s" }),
            /* @__PURE__ */ jsx(ArrowRight, { className: "h-3 w-3 text-muted-foreground" }),
            /* @__PURE__ */ jsx(FlowStep, { label: "QuickBooks", sub: "Expense posted", delay: "4.95s" })
          ] }) })
        ] })
      ] })
    ] })
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "text-[9px] text-muted-foreground", children: gl })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          status === "syncing" && flipDelay ? /* @__PURE__ */ jsxs("span", { className: "relative inline-flex", children: [
            /* @__PURE__ */ jsx("span", { className: "rounded-full bg-accent/15 px-1.5 py-0.5 text-[8px] font-bold uppercase tracking-wider text-accent", children: "Syncing" }),
            /* @__PURE__ */ jsx(
              "span",
              {
          ...
          ] }) : /* @__PURE__ */ jsx("span", { className: "rounded-full bg-success/15 px-1.5 py-0.5 text-[8px] font-bold uppercase tracking-wider text-success", children: "QB" })
        ] })
      ]
    }
  );
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-background", children: [
    /* @__PURE__ */ jsxs(Section, { tone: "surface", className: "py-5 sm:py-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-6 text-center", children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-accent", children: "From spreadsheet to synced" }),
        /* @__PURE__ */ jsx("h2", { className: "mt-2 text-2xl font-bold text-foreground sm:text-3xl", children: "Watch one charge go from chaos to coded in 6 seconds." })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-6xl", children: /* @__PURE__ */ jsx(BeforeAfterFlow, { chaos: /* @__PURE__ */ jsx(ExpenseChaos, {}), after: (playKey) => /* @__PURE__ */ jsx(ExpenseFlow, { playKey }), motion: "expenses" }) })
    ] }),
    /* @__PURE__ */ jsx(DeepSolutionLayout, { icon: Receipt, orbVariant: "expense", persona: "For Controllers & Property Accountants", eyebrow: "Expense Entries", title: /* @__PURE__ */ jsxs(Fragment, { children: [
      "Record once, ",
      /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "sync to your GL." })
      ...
      " ",
      "framework."
    ] }), bullets: ["Log credit card charges as they happen", "Record auto-paid invoices (utilities, subscriptions, recurring vendors)", "GL-code at entry — Innrly remembers the vendor mapping", "One-way sync to your accounting system as expense / already-paid items"], metrics: [{
      stat: "1",
      ...
      title: /* @__PURE__ */ jsxs(Fragment, { children: [
        "From ",
        /* @__PURE__ */ jsx("span", { className: "text-gradient", children: '"who paid for that?"' }),
        " to a clean GL."
      ] }),
      ...
      without: ["Credit card statement reconciled by hand at month-end", "Auto-paid utility invoices discovered three weeks after the debit", "GL coding done from memory at the close meeting", "Same vendor coded three different ways across three properties"],
      withTitle: "Posted the day it's spent",
      withItems: ["Card swipes logged from the property the same day", "Recurring auto-debits captured before they hit the statement", "Vendor memory pre-codes the next charge from the same vendor", "Portfolio-wide consistency — same vendor, same code, every time"]
    }, workflow: {
      title: /* @__PURE__ */ jsxs(Fragment, { children: [
        "How controllers ",
      ...
      title: /* @__PURE__ */ jsxs(Fragment, { children: [
        "What Expense Entries ",
        /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "replaces." })
      ] }),
      description: "These things go away.",
      items: ["Credit card reconciliation spreadsheets", "Manual journal entries for auto-paid invoices", '"Who swiped this card?" email threads', "Inconsistent GL coding across properties", 'Month-end "what was that charge?" hunts', "CSV imports into QuickBooks", "Side-spreadsheets that never tie to the GL"]
    }, quote: {
      text: "We used to discover utility auto-debits two weeks after they hit. Now they post the day they're spent, coded correctly, and the GL is current. Our close dropped from twelve days to four.",
      author: "Controller · 5-property portfolio"
    }, modules: {
      title: /* @__PURE__ */ jsxs(Fragment, { children: [
        "The modules behind ",
        /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "the entry." })
      ] }),
