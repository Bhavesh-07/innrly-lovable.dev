...
import { B as Button, n as faqs } from "./router-dBewJNnO.js";
import { Link } from "@tanstack/react-router";
import { ArrowRight, Clock, DollarSign, Users, Building2, Check } from "lucide-react";
import { E as Eyebrow, S as Section, a as SectionHeading, C as CtaBand } from "./Section-DfKao03n.js";
import { T as Testimonials } from "./Testimonials-CMTZr0Cp.js";
import { B as Breadcrumbs } from "./Breadcrumbs-CNu7uBt1.js";
import { A as Accordion, a as AccordionItem, b as AccordionTrigger, c as AccordionContent } from "./accordion-C7tmNJSl.js";
...
const checklist = ["Night-audit consolidation across OPERA, OnQ, FOSSE, choiceADVANTAGE, Visual Matrix", "Brand.com + OTA channel reconciliation (Expedia, Booking, Hotels.com)", "Franchise fee, royalty, and program-fee tracking", "Labor and overtime alerts before payroll runs", "Owner P&L packages with multi-property roll-up", "AP automation routed by property and GL code"];
function SelectServicePage() {
  return /* @__PURE__ */ jsxs("div", { className: "bg-background", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative mx-auto grid max-w-7xl gap-10 px-4 py-20 sm:px-6 lg:grid-cols-5 lg:px-8 lg:py-24", children: [
        /* @__PURE__ */ jsxs("div", { className: "lg:col-span-3", children: [
          ...
          /* @__PURE__ */ jsx("h1", { className: "mt-5 text-4xl font-bold leading-tight text-foreground sm:text-5xl lg:text-6xl", children: "Built for the way select-service portfolios actually run." }),
          /* @__PURE__ */ jsx("p", { className: "mt-5 text-lg text-muted-foreground", children: "You're managing 5, 15, or 50 hotels across multiple flags with a corporate team smaller than most single full-service properties. Innrly is the back-office layer that lets that math work." }),
          /* @__PURE__ */ jsxs("div", { className: "mt-8 flex flex-wrap gap-3", children: [
            ...
            /* @__PURE__ */ jsx(Button, { asChild: true, size: "lg", variant: "outline", className: "border-border bg-background/40", children: /* @__PURE__ */ jsx(Link, { to: "/case-studies/midwest-portfolio", children: "Read the 12-hotel case study" }) })
          ] })
        ] }),
    ...
    /* @__PURE__ */ jsxs(Section, { children: [
      /* @__PURE__ */ jsx(SectionHeading, { eyebrow: "Why select-service operators choose Innrly", title: "The four things that break at 10+ properties", description: "And what Innrly does about each of them." }),
    ...
    /* @__PURE__ */ jsx(Section, { className: "!pt-0", children: /* @__PURE__ */ jsx("div", { className: "rounded-3xl border border-border bg-surface/40 p-8 sm:p-12", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-10 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "mt-4 text-3xl font-bold text-foreground", children: "Everything a select-service back office needs, out of the box." }),
        /* @__PURE__ */ jsx("p", { className: "mt-4 text-muted-foreground", children: `No add-ons hunting. No "that's a custom build." The features below ship the day you sign.` })
      ] }),
    ...
    /* @__PURE__ */ jsxs(Section, { className: "!pt-0", children: [
      /* @__PURE__ */ jsx(SectionHeading, { eyebrow: "Common questions", title: "Select-service FAQ" }),
    ...
    /* @__PURE__ */ jsx(CtaBand, { title: "See Innrly with your own select-service portfolio", subtitle: "20-minute walkthrough using a sample of your actual PMS data.", primary: {
      to: "/contact",
      label: "Book a demo"
    }, secondary: {
...
export {
  SelectServicePage as component
};
