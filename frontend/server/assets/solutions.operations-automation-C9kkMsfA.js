...
import { Moon, Mail, FileText, StickyNote, AlertCircle, FileCheck2, Sun, Inbox, Workflow } from "lucide-react";
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 border-b border-border/40 pb-1", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-[10px] font-semibold text-foreground", children: "Night Audit Checklist · 11:42 PM" }),
            /* @__PURE__ */ jsx("span", { className: "ml-auto text-[9px] text-muted-foreground", children: "4 of 11 done" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "mt-1 space-y-0.5 text-[9px]", children: [
          ...
          ].map((row) => /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-[14px_1fr_60px] gap-1 text-foreground", children: [
            /* @__PURE__ */ jsx("span", { className: row.d ? "text-success" : "text-destructive", children: row.d ? "✓" : "○" }),
            /* @__PURE__ */ jsx("span", { className: "truncate", children: row.t }),
            /* @__PURE__ */ jsx(
              "span",
              {
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsx(Mail, { className: "h-3 w-3 text-primary" }),
              /* @__PURE__ */ jsx("span", { className: "truncate text-[10px] font-semibold text-foreground", children: "Corp · 11:08 PM" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mt-1 text-[10px] text-foreground", children: [
              '"',
              /* @__PURE__ */ jsx("span", { className: "font-semibold text-accent", children: "resend" }),
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 border-b border-border/40 pb-1", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "truncate text-[9px] font-semibold text-foreground", children: "Booking_Sept.csv" })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "mt-1 text-[9px] text-muted-foreground", children: "re-key 142 rows" })
          ]
        }
      ),
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
              ...
              /* @__PURE__ */ jsx("span", { children: "AGM" })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "mt-0.5 text-[9px] font-normal", children: "redo by 6 AM" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-[10px] font-semibold text-destructive", children: "Sunrise in 6 hours · 7 items still open" })
        ]
      }
    )
  ] });
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-background", children: [
    /* @__PURE__ */ jsxs(Section, { tone: "surface", className: "py-5 sm:py-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-6 text-center", children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-accent", children: "From 11 PM checklist to 6 AM queue" }),
        /* @__PURE__ */ jsx("h2", { className: "mt-2 text-2xl font-bold text-foreground sm:text-3xl", children: "Watch the night audit pack assemble itself before sunrise." })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-6xl", children: /* @__PURE__ */ jsx(BeforeAfterFlow, { chaos: /* @__PURE__ */ jsx(OpsChaos, {}), after: () => /* @__PURE__ */ jsx(OpsNightPack, {}), motion: "pulse" }) })
    ] }),
    /* @__PURE__ */ jsx(DeepSolutionLayout, { icon: Workflow, orbVariant: "ops", persona: "For Night Auditors & AGMs", eyebrow: "Hotel Back-Office Automation", title: /* @__PURE__ */ jsxs(Fragment, { children: [
      "Night audit, ",
      /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "done before" }),
      " sunrise."
      ...
      "."
    ] }), bullets: ["Night Audit+ runs automatically with variance flags surfaced by 6 AM", "OTA, bank, and credit-card reconciliation in the same pass", "Vendor invoices auto-pulled from portals and pre-coded", "Every report filed against a calendar — pull any night in two clicks"], metrics: [{
      stat: "20–40",
      ...
      title: /* @__PURE__ */ jsxs(Fragment, { children: [
        "From ",
        /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "four jobs at four hotels" }),
        " to one queue."
      ] }),
      description: "The night auditor's day shouldn't begin with re-keying.",
      withoutTitle: "The 4 AM grind",
      without: ["Run the PMS audit, print, email the pack to corporate", "Re-key OTA settlements into a separate spreadsheet", "Chase vendor invoices in three inboxes and a fax", "Hope the GM signs off before the AGM has to redo it"],
      withTitle: "The automated pack",
      withItems: ["Audit pack generated, filed to the calendar, emailed automatically", "OTA, bank, card recs run in the same pass with variance flags", "Vendor invoices pulled from portals overnight, OCR'd and GL-coded", "AGM gets one queue of exceptions — not a stack of paper"]
    }, workflow: {
      title: /* @__PURE__ */ jsxs(Fragment, { children: [
        "How ops teams ",
      ...
      title: /* @__PURE__ */ jsxs(Fragment, { children: [
        "What Innrly Operations Automation ",
        /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "replaces." })
      ] }),
      description: "These things go away.",
      items: ["Manual night audit emails to corporate", "OTA reconciliation spreadsheets", "Vendor portal logins for invoice pulls", "Folder-by-folder file storage", "Re-keying batch totals into accounting", '"Resend me the audit pack" requests', "Paper invoice routing"]
    }, quote: {
      text: "We had two night auditors quit because of the workload. After Innrly, the role is genuinely a 4-hour shift — they actually want it now. And the AGM walks in to a queue, not a panic.",
      author: "Director of Operations · 6-property select-service group"
    }, modules: {
      title: /* @__PURE__ */ jsxs(Fragment, { children: [
        "The modules behind ",
        /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "the automation." })
      ] }),
