...
import { v as defaultSeoData, w as fetchSeoData, B as Button, L as Label, I as Input, g as getApiBase } from "./router-CBR-JcUy.js";
...
function AdminSeoPage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      const res = await fetch(`${getApiBase()}/seo`, {
        method: "POST",
        headers: {
