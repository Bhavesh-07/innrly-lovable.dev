...
import { N as NewsletterSignup } from "./NewsletterSignup-Di0oS7cz.js";
import { D as Route } from "./router-DU7xSoX0.js";
import "lucide-react";
import "react";
import "zod";
import "sonner";
...
function readingTime(text) {
  if (!text) return 1;
  const words = text.replace(/(<([^>]+)>)/gi, " ").trim().split(/\s+/).length;
...
function BlogPost() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-background", children: [
    ...
    /* @__PURE__ */ jsxs(Section, { className: "max-w-3xl py-16", children: [
      /* @__PURE__ */ jsx(Link, { to: "/blog", className: "text-sm text-accent", children: "← Back to blog" }),
      /* @__PURE__ */ jsx("h1", { className: "mt-6 text-4xl font-bold text-foreground sm:text-5xl", children: post.title }),
      /* @__PURE__ */ jsxs("div", { className: "mt-4 flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-muted-foreground", children: [
        /* @__PURE__ */ jsx("span", { className: "font-medium text-foreground", children: post.author || "The Innrly Team" }),
        /* @__PURE__ */ jsx("span", { "aria-hidden": true, children: "·" }),
        /* @__PURE__ */ jsx("time", { dateTime: post.created_at, children: new Date(post.created_at).toLocaleDateString("en-US", {
          month: "long",
          day: "numeric",
          year: "numeric"
        }) }),
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-8 space-y-6 text-lg leading-relaxed text-muted-foreground blog-content", dangerouslySetInnerHTML: {
        __html: post.content
      } }),
      /* @__PURE__ */ jsxs("aside", { className: "mt-16 rounded-2xl border border-border bg-surface/40 p-6 sm:p-8", children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-accent", children: "Keep reading" }),
        /* @__PURE__ */ jsx("h2", { className: "mt-2 text-xl font-semibold text-foreground", children: "Related reading" }),
        /* @__PURE__ */ jsx("ul", { className: "mt-5 space-y-3", children: related.map((r) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("a", { href: r.to, className: "group flex items-baseline justify-between gap-4 rounded-lg border border-border/40 bg-background/40 px-4 py-3 transition-colors hover:border-accent/60", children: [
          /* @__PURE__ */ jsx("span", { className: "font-medium text-foreground group-hover:text-accent", children: r.label }),
          /* @__PURE__ */ jsx("span", { className: "shrink-0 text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: r.kind })
        ] }) }, r.to)) })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "mt-10", children: /* @__PURE__ */ jsx(NewsletterSignup, { source: `blog-post:${slug}` }) })
    ] })
  ] });
}
export {
