...
import { S as Section, a as SectionHeading } from "./Section-DfKao03n.js";
import { N as NewsletterSignup } from "./NewsletterSignup-DKpS2ec8.js";
import { ArrowRight } from "lucide-react";
import { R as Route } from "./router-dBewJNnO.js";
import "react";
import "zod";
import "sonner";
...
function BlogIndex() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-background", children: [
    ...
    /* @__PURE__ */ jsxs(Section, { children: [
      ...
      /* @__PURE__ */ jsxs("p", { className: "mt-12 text-center text-sm text-muted-foreground", children: [
