...
import { FileSpreadsheet, Building2, CreditCard, StickyNote, AlertCircle, Scale, BookOpen, ArrowRight, Check, Globe2, AlertTriangle, Banknote } from "lucide-react";
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 border-b border-border/40 pb-1", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-[10px] font-semibold text-foreground", children: "OTA_Statements_Oct.xlsx" }),
            /* @__PURE__ */ jsx("span", { className: "ml-auto text-[9px] text-muted-foreground", children: "17 rows · 6 unmatched" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mt-1 space-y-0.5 text-[9px]", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-[1fr_70px_70px] gap-1 text-muted-foreground", children: [
              /* @__PURE__ */ jsx("span", { children: "Source" }),
              /* @__PURE__ */ jsx("span", { children: "Statement" }),
              /* @__PURE__ */ jsx("span", { children: "PMS" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-[1fr_70px_70px] gap-1 text-foreground", children: [
              /* @__PURE__ */ jsx("span", { className: "truncate", children: "Expedia · 10/12" }),
              /* @__PURE__ */ jsx("span", { children: "$4,218.40" }),
              /* @__PURE__ */ jsx("span", { className: "rounded bg-destructive/15 px-1 text-center text-destructive", children: "$4,061.10" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-[1fr_70px_70px] gap-1 text-foreground", children: [
              /* @__PURE__ */ jsx("span", { className: "truncate", children: "Booking.com · 10/14" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-[1fr_70px_70px] gap-1 text-foreground", children: [
              /* @__PURE__ */ jsx("span", { className: "truncate", children: "Airbnb · 10/15" }),
              /* @__PURE__ */ jsx("span", { children: "$1,109.20" }),
              /* @__PURE__ */ jsx("span", { className: "rounded bg-destructive/15 px-1 text-center text-destructive", children: "$1,074.20" })
            ] })
          ] })
        ]
      }
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "truncate text-[10px] font-semibold text-foreground", children: "PMS Night Audit · DAL-12" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mt-1 flex items-baseline gap-1.5", children: [
              /* @__PURE__ */ jsx("span", { className: "text-[9px] text-muted-foreground", children: "Variance" }),
              /* @__PURE__ */ jsx("span", { className: "rounded-full border border-destructive/50 px-1.5 text-[10px] font-bold text-destructive", children: "−$1,247.83" })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx(CreditCard, { className: "h-3.5 w-3.5 shrink-0 text-primary" }),
            /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsx("div", { className: "truncate text-[10px] font-semibold text-foreground", children: "CC Batch · 10/14" }),
              /* @__PURE__ */ jsx("div", { className: "text-[9px] text-muted-foreground", children: "off by $43.10" })
            ] })
          ]
        }
      ),
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
              ...
              /* @__PURE__ */ jsx("span", { children: "Where?" })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "mt-0.5 text-[9px] font-normal", children: "Exp 10/12 deposit" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-[10px] font-semibold text-destructive", children: "11 days unreconciled · close at risk" })
        ]
      }
    )
  ] });
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-2xl border border-border bg-card shadow-elevated", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 border-b border-border/60 bg-surface/60 px-4 py-3", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "ml-3 text-xs font-medium text-muted-foreground", children: "Reconciliation · DAL-12" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative grid grid-cols-1 gap-3 p-4 md:grid-cols-5", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative col-span-2 rounded-xl border border-accent/40 bg-surface/60 p-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 border-b border-border/40 pb-2", children: [
            /* @__PURE__ */ jsx(Scale, { className: "h-3.5 w-3.5 text-accent" }),
            /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground", children: "3-way match" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mt-2 space-y-2 text-[11px]", children: [
            /* @__PURE__ */ jsx(MatchField, { label: "PMS Revenue", value: "$8,175.15", delay: "1.65s" }),
            /* @__PURE__ */ jsx(MatchField, { label: "Bank Deposit", value: "$8,175.15", delay: "2.05s", memory: true }),
            /* @__PURE__ */ jsx(MatchField, { label: "OTA Settle", value: "$8,175.15", delay: "2.45s", memory: true })
          ] }),
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider text-success", children: "Variance" }),
                /* @__PURE__ */ jsx("span", { className: "text-[11px] font-bold text-success", children: "$0.00 · cleared" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "ba-landing-glow col-span-3 space-y-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border/60 bg-surface/60 p-3", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 border-b border-border/40 pb-2", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground", children: "Today's matches" }),
              /* @__PURE__ */ jsx("span", { className: "ml-auto text-[9px] font-semibold text-foreground", children: "17 of 17" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mt-2 space-y-1", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "ba-slide-from-left opacity-0", style: { animationDelay: "3.35s" }, children: /* @__PURE__ */ jsx(
                MatchRow,
                {
          ...
          /* @__PURE__ */ jsx("div", { className: "rounded-xl border border-border/60 bg-surface/60 p-3", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2", children: [
            /* @__PURE__ */ jsx(FlowStep, { label: "PMS", sub: "Night audit", delay: "4.15s" }),
            /* @__PURE__ */ jsx(ArrowRight, { className: "h-3 w-3 text-muted-foreground" }),
            /* @__PURE__ */ jsx(FlowStep, { label: "Bank", sub: "Deposit", delay: "4.55s" }),
            /* @__PURE__ */ jsx(ArrowRight, { className: "h-3 w-3 text-muted-foreground" }),
            /* @__PURE__ */ jsx(FlowStep, { label: "OTA", sub: "Settlement", delay: "4.95s" })
          ] }) })
        ] })
      ] })
    ] })
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsx("span", { className: "text-[8px] font-bold uppercase tracking-wider text-muted-foreground", children: label }),
          memory && /* @__PURE__ */ jsx(
            "span",
            {
...
function MatchRow({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsx("div", { className: "truncate text-[11px] font-semibold text-foreground", children: source }),
          /* @__PURE__ */ jsx("div", { className: "text-[9px] text-muted-foreground", children: detail })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-[11px] font-bold text-foreground", children: amount }),
          status === "syncing" && flipDelay ? /* @__PURE__ */ jsxs("span", { className: "relative inline-flex", children: [
            /* @__PURE__ */ jsx("span", { className: "rounded-full bg-accent/15 px-1.5 py-0.5 text-[8px] font-bold uppercase tracking-wider text-accent", children: "Matching" }),
            /* @__PURE__ */ jsx(
              "span",
              {
          ...
          ] }) : /* @__PURE__ */ jsx("span", { className: "rounded-full bg-success/15 px-1.5 py-0.5 text-[8px] font-bold uppercase tracking-wider text-success", children: "✓" })
        ] })
      ]
    }
  );
...
function FlowStep({ label, sub, delay }) {
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center text-center", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mt-1 text-[10px] font-bold text-foreground", children: label }),
    /* @__PURE__ */ jsx("div", { className: "text-[8px] text-muted-foreground", children: sub })
  ] });
}
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-2xl border border-border bg-card shadow-elevated", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 border-b border-border/60 bg-surface/60 px-4 py-3", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-muted-foreground", children: "OTA commission audit · Expedia · Oct" }),
        /* @__PURE__ */ jsx("span", { className: "ml-auto rounded-full bg-success/15 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-success", children: "$1,842 recovered" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "p-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-[1fr_auto_1fr_auto] gap-x-3 gap-y-1.5 text-[11px]", children: [
          /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold uppercase tracking-wider text-muted-foreground", children: "PMS folio" }),
          /* @__PURE__ */ jsx("span", {}),
          /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold uppercase tracking-wider text-muted-foreground", children: "OTA statement" }),
          /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold uppercase tracking-wider text-muted-foreground", children: "Δ" }),
          /* @__PURE__ */ jsx(Row, { pms: "Res #88210 · $412.00", ota: "$412.00 · 18% · $74.16", delta: "ok" }),
          /* @__PURE__ */ jsx(
            Row,
            {
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-3 flex items-center justify-between rounded-lg bg-accent/10 px-3 py-2", children: [
          /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider text-accent", children: [
            /* @__PURE__ */ jsx(Check, { className: "h-3 w-3" }),
            " Dispute drafted · routed to GM"
          ] }),
          /* @__PURE__ */ jsx("span", { className: "text-[10px] font-semibold text-foreground", children: "2 lines · auto-attached" })
        ] })
      ] })
    ] })
  ] });
...
function Row({
  ...
  const tone = delta === "ok" ? "text-success" : delta === "over" ? "text-chart-4" : "text-destructive";
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("span", { className: "truncate text-foreground", children: pms }),
    /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "→" }),
    /* @__PURE__ */ jsx("span", { className: "truncate text-foreground", children: ota }),
    /* @__PURE__ */ jsxs("span", { className: `flex items-center gap-1 text-[9px] font-bold ${tone}`, children: [
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-background", children: [
    /* @__PURE__ */ jsxs(Section, { tone: "surface", className: "py-5 sm:py-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-6 text-center", children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-accent", children: "From variance to matched" }),
        /* @__PURE__ */ jsx("h2", { className: "mt-2 text-2xl font-bold text-foreground sm:text-3xl", children: "Watch unmatched settlements snap into place in 6 seconds." })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-6xl", children: /* @__PURE__ */ jsx(BeforeAfterFlow, { chaos: /* @__PURE__ */ jsx(ReconciliationChaos, {}), after: (playKey) => /* @__PURE__ */ jsx(ReconciliationFlow, { playKey }), motion: "expenses" }) })
    ] }),
    /* @__PURE__ */ jsx(DeepSolutionLayout, { icon: Scale, orbVariant: "reconciliation", persona: "For Controllers & Corporate Accountants", eyebrow: "Hotel Reconciliation", title: /* @__PURE__ */ jsxs(Fragment, { children: [
      "Reconciliation that ",
      /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "closes books daily." })
    ] }), description: /* @__PURE__ */ jsxs(Fragment, { children: [
      "Automated daily reconciliation across PMS, bank, credit card, and OTA deposits. Variances surface in hours, not at month-end — across every property in your portfolio. Learn how this integrates into our wider",
      " ",
      ...
      " ",
      "system."
    ] }), bullets: ["Daily PMS-to-bank reconciliation, fully automated", "Credit card settlement matching with chargeback alerts", "OTA commission audit — Expedia, Booking.com, Airbnb", "Variance exceptions routed to the right GM or controller"], metrics: [{
      stat: "8hrs",
      ...
      title: /* @__PURE__ */ jsxs(Fragment, { children: [
        "From ",
        /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "two-week close" }),
        " to two-day close."
      ] }),
      ...
      without: ["Spend two weeks matching deposits to PMS folios by hand", "Discover chargebacks 45 days after they happened", "Pay OTA commissions on bookings that never checked in", "Find out about a bank deposit short on day 28 of the close"],
      withTitle: "Already reconciled by tomorrow",
      withItems: ["Every deposit matched to PMS the morning after it lands", "Chargeback alerts the same day the merchant batch hits", "OTA commission audit catches over-billing line by line", "Variance exceptions routed with full context, not a spreadsheet"]
    }, workflow: {
      title: /* @__PURE__ */ jsxs(Fragment, { children: [
        "How controllers ",
      ...
      items: ["Month-end reconciliation marathons", "Per-property bank-rec spreadsheets", "Manual OTA commission audits", "Discovering chargebacks 45 days late", '"Send me your settlement file" emails', "Forensic month-end variance hunts", "Two-week close cycles"]
    }, quote: {
      text: "We went from a fourteen-day close to a four-day close in our first quarter on Innrly. The OTA audit alone paid for the platform — we recovered eleven thousand in mis-billed commissions in month one.",
      author: "Corporate Controller · 9-property portfolio"
    }, modules: {
      title: /* @__PURE__ */ jsxs(Fragment, { children: [
        "The modules behind ",
        /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "the match." })
      ] }),
