  ...
  return /* @__PURE__ */ jsx("div", { className: "bg-background", children: /* @__PURE__ */ jsxs(Section, { className: "max-w-3xl py-16", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "prose prose-invert mt-10 max-w-none space-y-6 text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsxs("ul", { className: "list-disc space-y-2 pl-6", children: [
        ...
        /* @__PURE__ */ jsxs("li", { children: [
          /* @__PURE__ */ jsx("strong", { className: "text-foreground", children: "Biometric data:" }),
          " where you enable the face-recognition time clock, face-geometry templates processed solely to authenticate shift punches (see Section 16 of the Subscription Services Agreement)."
        ] }),
        /* @__PURE__ */ jsxs("li", { children: [
      ...
      /* @__PURE__ */ jsxs("p", { children: [
        ...
        " The Services are not designed for, and do not accept, Protected Health Information (PHI) as defined by HIPAA. Do not upload PHI to the Services."
      ] }),
      ...
      /* @__PURE__ */ jsxs("ul", { className: "list-disc space-y-2 pl-6", children: [
        ...
        /* @__PURE__ */ jsx("li", { children: "Create aggregated and de-identified data that does not identify you or any individual, and use it for analytics, product development and improvement, benchmarking, and training machine-learning models." })
      ] }),
      ...
      /* @__PURE__ */ jsxs("ul", { className: "list-disc space-y-2 pl-6", children: [
        /* @__PURE__ */ jsx("li", { children: "Cloud hosting and infrastructure (AWS, Cloudflare)." }),
        /* @__PURE__ */ jsx("li", { children: "Email and SMS delivery (Resend / SendGrid, Twilio)." }),
        /* @__PURE__ */ jsx("li", { children: "Payment processing for vendor disbursements (Repay), where enabled." }),
        /* @__PURE__ */ jsx("li", { children: "Bank-account connectivity for deposit reconciliation (Plaid), where enabled." }),
        /* @__PURE__ */ jsx("li", { children: "Analytics and product telemetry (GA4, PostHog), where enabled." }),
      ...
      /* @__PURE__ */ jsxs("ul", { className: "list-disc space-y-2 pl-6", children: [
        ...
        /* @__PURE__ */ jsxs("li", { children: [
          /* @__PURE__ */ jsx("strong", { className: "text-foreground", children: "Biometric data (time clock):" }),
          " where enabled, deleted when the purpose for collection is satisfied (for example, end of employment) or within the shorter of the period required by law or three years after the worker's last interaction, whichever occurs first."
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxs("p", { children: [
        ...
        " ",
        "identifiers (name, email, phone), commercial information, internet/network activity, geolocation (approximate, IP-based), professional information, and (where the biometric time clock is enabled) sensitive personal information consisting of biometric information.",
        " ",
      ...
      /* @__PURE__ */ jsxs("address", { className: "not-italic rounded-2xl border border-border bg-card/60 p-5 text-sm", children: [
        /* @__PURE__ */ jsx("div", { className: "font-semibold text-foreground", children: "Mystic Solutions LLC — Privacy" }),
