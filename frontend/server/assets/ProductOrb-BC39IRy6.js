...
import { c as cn } from "./router-CCF17sca.js";
const palettes = {
...
function ProductOrb({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      ` }),
        /* @__PURE__ */ jsxs("div", { className: wrapId, style: { position: "absolute", inset: 0 }, children: [
          !noBloom && /* @__PURE__ */ jsx(
            "div",
            {
        ...
        (eyebrow || label || sublabel) && /* @__PURE__ */ jsxs("div", { className: "pointer-events-none relative z-10 px-2 text-center", children: [
          eyebrow && /* @__PURE__ */ jsx("div", { className: cn("font-bold uppercase tracking-[0.2em] text-accent", s.eyebrow), children: eyebrow }),
          label && /* @__PURE__ */ jsx("div", { className: cn("font-semibold text-foreground", s.label), children: label }),
          sublabel && /* @__PURE__ */ jsx("div", { className: cn("text-muted-foreground", s.sub), children: sublabel })
        ] })
      ]
    }
  );
