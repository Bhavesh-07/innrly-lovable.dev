...
import { W as Wordmark, c as cn, B as Button } from "./router-dBewJNnO.js";
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-background", children: [
    ...
    /* @__PURE__ */ jsxs(Section, { tone: "surface", children: [
      /* @__PURE__ */ jsx(SectionHeading, { eyebrow: "From operators", title: "What hotel groups say.", description: "Anonymized to protect operator portfolios. Logos and attributed quotes available under NDA.", align: "center" }),
      /* @__PURE__ */ jsx("div", { className: "mt-12 grid gap-6 lg:grid-cols-2", children: testimonials.map((t, i) => /* @__PURE__ */ jsxs("figure", { className: "aurora-card rounded-2xl p-8", children: [
        /* @__PURE__ */ jsxs("blockquote", { className: "text-lg leading-relaxed text-foreground", children: [
          '"',
          t.quote,
          '"'
        ] }),
        /* @__PURE__ */ jsxs("figcaption", { className: "mt-6 flex items-center gap-3 border-t border-border/60 pt-4", children: [
          /* @__PURE__ */ jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-full bg-cta text-sm font-bold text-primary-foreground", "aria-hidden": true, children: t.name.charAt(0) }),
          /* @__PURE__ */ jsxs("div", { children: [
