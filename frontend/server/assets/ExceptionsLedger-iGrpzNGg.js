  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-2xl border border-border bg-card shadow-elevated", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 border-b border-border/60 bg-surface/60 px-4 py-3", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "ml-3 text-xs font-medium text-muted-foreground", children: "Exceptions · Controller view · today" }),
        /* @__PURE__ */ jsxs("div", { className: "ml-auto flex items-center gap-1.5 text-[10px] font-medium text-accent", children: [
          /* @__PURE__ */ jsx(DollarSign, { className: "h-3 w-3" }),
          "$4,287 RECOVERABLE"
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "p-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "relative mb-3 overflow-hidden rounded-xl border border-border/60 bg-surface/60 p-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-4 gap-2", children: [
            /* @__PURE__ */ jsx(Stat, { label: "Reconciled", value: "14,209", good: true }),
            /* @__PURE__ */ jsx(Stat, { label: "Exceptions", value: "7", warn: true }),
            /* @__PURE__ */ jsx(Stat, { label: "OTA caught", value: "$2.8K" }),
            /* @__PURE__ */ jsx(Stat, { label: "Bank var.", value: "$1.4K" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "mt-2 text-[9px] font-semibold uppercase tracking-wider text-muted-foreground", children: "14,209 transactions scanned · 7 surfaced" })
        ] }),
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-[11px] text-foreground", children: [
                /* @__PURE__ */ jsx(Check, { className: "h-3.5 w-3.5 text-success" }),
                /* @__PURE__ */ jsx("span", { children: "14,202 of 14,209 auto-cleared overnight — work only the 7" })
              ] }),
              /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold text-accent", children: "Work the exceptions" })
            ]
          }
        )
      ] })
    ...
    /* @__PURE__ */ jsxs("div", { className: "absolute -right-3 -top-3 hidden rounded-xl border border-border bg-card px-4 py-3 shadow-elevated sm:block", children: [
      /* @__PURE__ */ jsx("div", { className: "text-[10px] font-medium uppercase tracking-wider text-muted-foreground", children: "Caught in 60 days" }),
      /* @__PURE__ */ jsx("div", { className: "text-lg font-bold text-foreground", children: "Recoverable" }),
      /* @__PURE__ */ jsx("div", { className: "text-[10px] text-muted-foreground", children: "varies by portfolio" })
    ] })
  ] });
}
function Stat({
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: "text-[11px] font-bold text-foreground", children: prop }),
            /* @__PURE__ */ jsx("span", { className: "rounded bg-border/40 px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-wider text-muted-foreground", children: type })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "mt-0.5 truncate text-[10px] text-muted-foreground", children: detail })
        ] }),
        /* @__PURE__ */ jsx("span", { className: "text-[11px] font-bold text-accent", children: amount })
      ]
    }
  );
}
export {
  ExceptionsLedger as E
};
