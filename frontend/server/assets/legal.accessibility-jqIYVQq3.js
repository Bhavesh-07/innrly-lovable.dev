...
function AccessibilityPage() {
  return /* @__PURE__ */ jsx("div", { className: "bg-background", children: /* @__PURE__ */ jsxs(Section, { className: "max-w-3xl py-16", children: [
    /* @__PURE__ */ jsx("h1", { className: "text-4xl font-bold text-foreground", children: "Accessibility Statement" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "prose prose-invert mt-10 max-w-none space-y-6 text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold text-foreground", children: "Our standard" }),
      /* @__PURE__ */ jsxs("p", { children: [
        "We target conformance with the",
        " ",
        /* @__PURE__ */ jsx("a", { href: "https://www.w3.org/TR/WCAG21/", target: "_blank", rel: "noopener noreferrer", className: "underline", children: "Web Content Accessibility Guidelines (WCAG) 2.1 Level AA" }),
      ...
      /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold text-foreground", children: "What we do" }),
      ...
      /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold text-foreground", children: "Known limitations" }),
      ...
      /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold text-foreground", children: "Report an issue" }),
      ...
      /* @__PURE__ */ jsxs("p", { children: [
        "Email:",
        " ",
        /* @__PURE__ */ jsx("a", { href: "mailto:accessibility@innrly.com", className: "underline", children: "accessibility@innrly.com" }),
        /* @__PURE__ */ jsx("br", {}),
        "Please include the page URL, the issue you encountered, and the assistive technology or browser you were using."
      ] }),
      /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold text-foreground", children: "Formal complaints" }),
