...
import { B as Button, q as faqs } from "./router-CCF17sca.js";
...
const checklist = ["Long-stay folio revenue recognition by night, not by check-out", "Weekly housekeeping MPOR benchmarks and schedule templates", "Direct-bill corporate account reconciliation and aging", "Project rate and contract audits with variance alerts", "Multi-brand consolidation across extended-stay flags", "Lean-team labor models with overtime and OT trend alerts"];
function ExtendedStayPage() {
  return /* @__PURE__ */ jsxs("div", { className: "bg-background", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative mx-auto grid max-w-7xl gap-10 px-4 py-20 sm:px-6 lg:grid-cols-5 lg:px-8 lg:py-24", children: [
        /* @__PURE__ */ jsxs("div", { className: "lg:col-span-3", children: [
          ...
          /* @__PURE__ */ jsx("h1", { className: "mt-5 text-4xl font-bold leading-tight text-foreground sm:text-5xl lg:text-6xl", children: "Built for the way extended-stay actually runs." }),
          /* @__PURE__ */ jsx("p", { className: "mt-5 text-lg text-muted-foreground", children: "Extended-stay is not just select-service with longer stays. Long folios, weekly housekeeping, project-rate corporate accounts, and lean teams change every part of the back office. Innrly is tuned for it." }),
          /* @__PURE__ */ jsxs("div", { className: "mt-8 flex flex-wrap gap-3", children: [
            ...
            /* @__PURE__ */ jsx(Button, { asChild: true, size: "lg", variant: "outline", className: "border-border bg-background/40", children: /* @__PURE__ */ jsx(Link, { to: "/solutions/reconciliation", children: "See reconciliation" }) })
          ] })
        ] }),
    ...
    /* @__PURE__ */ jsxs(Section, { children: [
      /* @__PURE__ */ jsx(SectionHeading, { eyebrow: "Why extended-stay operators choose Innrly", title: "The four things generic hotel software gets wrong", description: "And what Innrly does about each of them." }),
    ...
    /* @__PURE__ */ jsx(Section, { className: "!pt-0", children: /* @__PURE__ */ jsx("div", { className: "rounded-3xl border border-border bg-surface/40 p-8 sm:p-12", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-10 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "mt-4 text-3xl font-bold text-foreground", children: "Extended-stay specifics, not retrofits." }),
        /* @__PURE__ */ jsx("p", { className: "mt-4 text-muted-foreground", children: `Out of the box — no "we'll customize that" and no extra modules to license.` })
      ] }),
    ...
    /* @__PURE__ */ jsxs(Section, { className: "!pt-0", children: [
      /* @__PURE__ */ jsx(SectionHeading, { eyebrow: "Common questions", title: "Extended-stay FAQ" }),
    ...
    /* @__PURE__ */ jsx(CtaBand, { title: "See Innrly on your extended-stay portfolio", subtitle: "20-minute walkthrough using a sample of your actual PMS and folio data.", primary: {
      to: "/contact",
      label: "Book a demo"
    }, secondary: {
