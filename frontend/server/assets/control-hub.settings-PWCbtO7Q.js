...
import { c as cn, B as Button, g as getApiBase } from "./router-CBR-JcUy.js";
...
function AdminSettings() {
  ...
  const [webhookUrl, setWebhookUrl] = useState(typeof window !== "undefined" && window.location.hostname !== "localhost" && window.location.hostname !== "127.0.0.1" ? "/leads" : "http://127.0.0.1:8000/leads");
