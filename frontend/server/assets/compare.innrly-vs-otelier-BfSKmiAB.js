...
import { x as faqs } from "./router-DU7xSoX0.js";
import { C as CompareLayout } from "./CompareLayout-BvjeFnuz.js";
...
import "sonner";
import "./Section-YatvVMiA.js";
import "./Breadcrumbs-CNu7uBt1.js";
function Page() {
  return /* @__PURE__ */ jsx(CompareLayout, { competitorName: "Otelier", eyebrow: "Innrly: alternative to Otelier", title: /* @__PURE__ */ jsxs(Fragment, { children: [
    "How Innrly and Otelier ",
    /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "compare." })
  ] }), intro: "Both platforms cover the core hotel back-office workflows — night audit, OTA reconciliation, A/P automation, BI, Bill Pay, payroll, and rate shopping. This page highlights the specific places where the two products differ in commercial terms, deployment, and a few feature areas.", summary: [{
    ...
    innrly: ["You want month-to-month flexibility, with the option of an annual plan that includes onboarding", "You want a real 90-day trial to validate value on your own data first", "You want Face-ID TimeClock and a Housekeeping productivity matrix in the same product as scheduling and payroll", "You prefer one platform with a single data model across BI, A/P, Bill Pay, labor, and payroll"],
    competitor: ["You already license MyDigitalOffice or Datavision and don't want to migrate", "You prefer a multi-module suite under one parent brand and are comfortable with annual contracts"]
  }, faqs });
}
export {
  Page as component
