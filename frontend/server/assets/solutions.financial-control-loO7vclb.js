...
import { Calendar, FileSpreadsheet, StickyNote, AlertCircle, ScanSearch, BookOpenCheck, Banknote, ShieldCheck } from "lucide-react";
...
function FinancialControlChaos() {
  return /* @__PURE__ */ jsxs("div", { className: "relative flex h-full flex-col space-y-2", children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 border-b border-border/40 pb-1", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-[10px] font-semibold text-foreground", children: "Close Calendar · Day 11" }),
            /* @__PURE__ */ jsx("span", { className: "ml-auto text-[9px] text-destructive", children: "5 overdue" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "mt-1 grid grid-cols-7 gap-0.5", children: Array.from({ length: 14 }).map((_, i) => /* @__PURE__ */ jsx(
            "div",
            {
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 border-b border-border/40 pb-1", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "truncate text-[9px] font-semibold text-foreground", children: "TB_DAL12_v7_FINAL.xlsx" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mt-1 grid grid-cols-2 gap-0.5 text-[9px]", children: [
              /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "Cash" }),
              /* @__PURE__ */ jsx("span", { className: "text-foreground", children: "$184,210" }),
              /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "A/R" }),
              /* @__PURE__ */ jsx("span", { className: "text-foreground", children: "$ 47,883" }),
              /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "Variance" }),
              /* @__PURE__ */ jsx("span", { className: "rounded bg-destructive/20 px-1 font-bold text-destructive", children: "($3,140)" })
            ] })
          ]
        }
      ),
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
              ...
              /* @__PURE__ */ jsx("span", { children: "P&L late" })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "mt-0.5 text-[9px] font-normal", children: "AUS-03 still pending" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 border-b border-border/40 pb-1", children: [
            /* @__PURE__ */ jsx(FileSpreadsheet, { className: "h-3 w-3 text-muted-foreground" }),
            /* @__PURE__ */ jsx("span", { className: "text-[9px] font-semibold text-muted-foreground", children: "Open tabs · 7 spreadsheets" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "mt-1.5 space-y-1", children: [
          ...
          ].map((row) => /* @__PURE__ */ jsxs(
            "div",
            {
              className: "flex items-center justify-between rounded bg-muted/20 px-1.5 py-0.5 text-[9px]",
              children: [
                /* @__PURE__ */ jsx("span", { className: "truncate text-foreground/80", children: row.name }),
                /* @__PURE__ */ jsx("span", { className: "ml-2 shrink-0 text-destructive/80", children: row.note })
              ]
            },
            row.name
          )) })
    ...
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-[10px] font-semibold text-destructive", children: "Close slipping · CFO asking on day 11" })
        ]
      }
    )
  ] });
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-background", children: [
    /* @__PURE__ */ jsxs(Section, { tone: "surface", className: "py-5 sm:py-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-6 text-center", children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-accent", children: "From day-11 scramble to day-3 close" }),
        /* @__PURE__ */ jsx("h2", { className: "mt-2 text-2xl font-bold text-foreground sm:text-3xl", children: "Watch the close calendar light up green in 6 seconds." })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-6xl", children: /* @__PURE__ */ jsx(BeforeAfterFlow, { chaos: /* @__PURE__ */ jsx(FinancialControlChaos, {}), after: () => /* @__PURE__ */ jsx(ExceptionsLedger, {}), motion: "guardrails" }) })
    ] }),
    /* @__PURE__ */ jsx(DeepSolutionLayout, { icon: ShieldCheck, orbVariant: "control", persona: "For Controllers & CFOs", eyebrow: "Hotel Accounting & Reconciliation", title: /* @__PURE__ */ jsxs(Fragment, { children: [
      "Work the ",
      /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "exceptions" }),
      ...
      "."
    ] }), bullets: ["Auto-match every deposit, batch, and OTA settlement to the PMS", "Variances flagged within hours, not at month-end close", "Audit-ready trail packaged on the 1st of every month", "Recover OTA commission clawbacks and undercharged group bills automatically"], metrics: [{
      stat: "Recoverable",
      ...
      title: /* @__PURE__ */ jsxs(Fragment, { children: [
        "From ",
        /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "tick-and-tie" }),
      ...
      without: ["Export PMS, bank, OTA reports into seven spreadsheets", "Eyeball thousands of matched lines looking for a few breaks", "Discover the OTA commission overcharge weeks after it could have been disputed", "Stitch together an audit binder by hand on the 5th of the month"],
      withTitle: "Exceptions-only ledger",
      withItems: ["The vast majority of transactions auto-clear overnight", "The 7 that need a human are on one screen with the dollar amount", "Chargebacks and undercharged group bills surface inside 24 hours", "Month-end pack is generated, not assembled"]
    }, workflow: {
      title: /* @__PURE__ */ jsxs(Fragment, { children: [
        "How controllers ",
      ...
      items: ["Bank rec spreadsheets", "OTA commission clawback hunts", "Manual folio-to-deposit matching", "End-of-month audit binders", "A/R aging by hand", "Comp & void chase reports", '"Tie out the night audit" tasks']
    }, quote: {
      text: "We used to spend the first ten days of every month closing the prior month. Now my controller spends those ten days on actual analysis. Innrly didn't speed up reconciliation — it removed it.",
      author: "CFO · 12-property hotel ownership group"
    }, modules: {
      title: /* @__PURE__ */ jsxs(Fragment, { children: [
        "The modules behind ",
        /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "the close." })
      ] }),
