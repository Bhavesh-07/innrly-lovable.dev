...
import { y as faqs } from "./router-DU7xSoX0.js";
...
function Page() {
  return /* @__PURE__ */ jsx(CompareLayout, { competitorName: "Nimble Property", eyebrow: "Innrly: alternative to Nimble Property", title: /* @__PURE__ */ jsxs(Fragment, { children: [
    "How Innrly and Nimble Property ",
    /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "compare." })
  ] }), intro: "Both platforms target multi-property hotel back-office automation. This page highlights the specific differences in commercial terms, deployment, labor + housekeeping, and A/P automation that matter to operator-buyers.", summary: [{
    ...
    feature: "BI dashboards",
    innrly: true,
    competitor: true
  }, {
    feature: "QuickBooks / M3 / Sage Intacct sync",
    innrly: true,
    competitor: true
  }], whenToChoose: {
    innrly: ["You want published pricing and a real 90-day trial to validate value on your own data first", "You want Face-ID TimeClock + housekeeping productivity matrix in the same product as scheduling and payroll", "You want a 2–4 week deployment, not a quarter-long implementation", "You want one platform with a single data model across BI, A/P, night audit, labor, and payroll"],
    competitor: ["You're already deeply embedded in Nimble Property and don't want to migrate", "You prefer a hardware-agnostic time-clock partnership over a native Face-ID device"]
  }, faqs });
}
export {
  Page as component
