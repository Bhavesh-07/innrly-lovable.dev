...
function Page() {
  return /* @__PURE__ */ jsxs("div", { className: "bg-background", children: [
    /* @__PURE__ */ jsx(ModuleSpotlightCard, { moduleKey: "pay", moduleName: "Innrly Pay", pricing: "addon", blurb: "Virtual Cards + ACH replace paper checks. Available as a paid add-on — try it during your 90-day trial." }),
